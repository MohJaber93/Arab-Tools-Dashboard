...
const EditCoupon = () => {
    ...
    React.useEffect(()=>{
        ...
        location.state.row.start_date=location.state.row.start_date.substr(0, 16);
        location.state.row.end_date=location.state.row.end_date.substr(0, 16);
        setFormInput(location.state.row)
    },[])
    ...
    const submitForm=(event)=>{
        ...
        axios.patch(BASE_URL+"/api/v1/inventory/coupon/"+formInput.id,{
            "code":formInput.code,
    ...
    return (<>
        <Row>
            <Col>
                <Card>
                    <Card.Header>
                        <Card.Title as="h5">Edit Coupon</Card.Title>
                    </Card.Header>
                    <Card.Body>
