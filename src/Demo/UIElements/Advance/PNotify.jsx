        ...
        modules: {
            Callbacks: {
                ...
                afterInit: function (notice) {
                    dontAlert("I'm called after the notice initializes. I'm passed the PNotify object for the current notice: " +
                        notice +
                ...
                beforeClose: function (notice, timerHide) {
                    ...
                    dontAlert('I also have an argument called timerHide, which is true if the notice was closed because the timer ran down. Value: ' +
                        timerHide);
                },
                            ...
                            <Table responsive>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <Button size="sm" onClick={progressButtonPNotify}>
                                                <i className="feather icon-bell"/> Click Here!
                                            </Button>
                                        </td>
                                        <td>
                                            Set <code>function</code> like, <code>progressButtonPNotify</code>
                                        </td>
                                    </tr>
                                    <tr>
