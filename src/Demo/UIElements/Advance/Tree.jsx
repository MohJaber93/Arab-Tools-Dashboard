            ...
            <Row>
                ...
                <Col sm={12} md={6} xl={4}>
                    <Card>
                        ...
                        <Card.Body>
                            <TreeView className="customizable-tree" theme="purple" items={treeData} showRoot={true} showCheckbox={true} selectRow={true}/>
                        </Card.Body>
                    </Card>
                </Col>
                <Col sm={12} md={6} xl={4}>
                ...
                <Col sm={12} md={6} xl={4}>
                    <Card>
                        ...
                        <Card.Body>
                            <div>
                                <AnimatedTree content="Root Node" type={typeFolder} canHide open 
    // @ts-ignore
    style={treeStyles}>
