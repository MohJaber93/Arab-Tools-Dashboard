...
const Cards = () => {
    ...
    const cardStyles = cardVariants.map((variant, idx) => (<Col key={idx} xl={4} md={6}>
            <Card bg={variant} text={variant !== 'light' ? 'white' : undefined}>
                <Card.Header>Header</Card.Header>
                <Card.Body>
                    <Card.Title as="h5" className={variant !== 'light' ? 'text-white' : ''}>
                        <UcFirst text={variant}/> Card Title
                    </Card.Title>
                ...
                <Col md={6} xl={4}>
                    ...
                    <Card>
                        <Card.Body>
                            ...
                            <Card.Link href={DEMO.BLANK_LINK}>Card Link</Card.Link>
                            <Card.Link href={DEMO.BLANK_LINK}>Another Link</Card.Link>
                        </Card.Body>
                    </Card>
                </Col>
                <Col md={6} xl={4}>
            ...
            <Row>
                ...
                <Col sm={12}>
                    ...
                    <CardColumns>
                        ...
                        <Card text="white" className="text-center bg-c-blue">
                            <Card.Body>
