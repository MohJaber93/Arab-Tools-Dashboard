                    ...
                    <Card>
                        ...
                        <Card.Body>
                            ...
                            <Card.Text>
                                ...
                                built with{' '}
                                <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Flexible_Box_Layout/Basic_Concepts_of_Flexbox" rel="noopener noreferrer" target="_blank">
                                    flexbox
                                </a>{' '}
                            ...
                            <Card.Text>
                                ...
                                <a href="https://css-tricks.com/snippets/css/a-guide-to-flexbox/#flexbox-background" rel="noopener noreferrer" target="_blank">
                                    {' '}
                    ...
                    <Card>
                        ...
                        <Card.Body>
                            ...
                            <div className="bd-example-row">
                                ...
                                <Prism code={autoLayoutEqualWidth} language="markup"/>
                            </div>
                            ...
                            <Card.Text>
                                ...
                                <a href={DEMO.BLANK_LINK}>responsive display utilities</a>.
                            </Card.Text>
                            ...
                            <div className="bd-example-row">
                                ...
                                <Prism code={autoLayoutMultiLine} language="markup"/>
                            </div>
                            ...
                            <div className="bd-example-row">
                                ...
                                <Prism code={autoLayoutFixedOneColumn} language="markup"/>
                            </div>
                            ...
                            <div className="bd-example-row">
                                ...
                                <Prism code={autoLayoutVariableWidth} language="markup"/>
                            </div>
                        </Card.Body>
                    </Card>
                    <Card>
                        ...
                        <Card.Body>
                            ...
                            <div className="bd-example-row">
                                ...
                                <Prism code={responsiveBasic} language="markup"/>
                            </div>
                            ...
                            <div className="bd-example-row">
                                ...
                                <Prism code={responsiveStacked} language="markup"/>
                            </div>
                            ...
                            <div className="bd-example-row">
                                ...
                                <Prism code={responsiveMixMatch} language="markup"/>
                            </div>
                        </Card.Body>
                    </Card>
                    <Card>
                        ...
                        <Card.Body>
                            ...
                            <div className="bd-example-row">
                                ...
                                <Prism code={reOrdering} language="markup"/>
                            </div>
                        </Card.Body>
                    </Card>
                    <Card>
                        ...
                        <Card.Body>
                            ...
                            <div className="bd-example-row">
                                ...
                                <Prism code={columnOffset} language="markup"/>
                            </div>
                        </Card.Body>
                    </Card>
                </Col>
