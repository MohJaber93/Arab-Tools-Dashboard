    ...
    return (<>
            <Row className="btn-page">
                <Col sm={12}>
                    ...
                    <Card>
                        <Card.Header>
                            <Button href={DEMO.BLANK_LINK} onClick={() => setIsBasic(!isBasic)} aria-controls="basic-collapse" aria-expanded={isBasic}>
                                Collapse Link
                            </Button>
                ...
                <Col sm={12}>
                    ...
                    <hr />
                    <Button onClick={() => targetHandler('target1')} aria-controls="target1" aria-expanded={isMultiTarget.some((target) => target === 'target1')}>
                        Toggle first element
                    </Button>
                    <Button onClick={() => targetHandler('target2')} aria-controls="target2" aria-expanded={isMultiTarget.some((target) => target === 'target2')}>
                ...
                <Col sm={12} className="accordion">
                    ...
                    <Card className="mt-2">
                        <Card.Header>
                            <Card.Title as="h5">
                                <a href={DEMO.BLANK_LINK} onClick={() => setAccordionKey(accordionKey !== 1 ? 1 : 0)} aria-controls="accordion1" aria-expanded={accordionKey === 1}>
                    ...
                    <Card className="mt-2">
                        <Card.Header>
                            <Card.Title as="h5">
                                <a href={DEMO.BLANK_LINK} onClick={() => setAccordionKey(accordionKey !== 2 ? 2 : 0)} aria-controls="accordion2" aria-expanded={accordionKey === 2}>
                    ...
                    <Card className="mt-2">
                        <Card.Header>
                            <Card.Title as="h5">
                                <a href={DEMO.BLANK_LINK} onClick={() => setAccordionKey(accordionKey !== 3 ? 3 : 0)} aria-controls="accordion3" aria-expanded={accordionKey === 3}>
