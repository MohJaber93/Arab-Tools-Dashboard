...
const TooltipsPopovers = () => {
    const htmlTitle = (<span>
            <i>Popover</i> <u>with</u> <strong>HTML</strong>
        </span>);
    return (<>
            <Row className="btn-page">
                <Col md={6}>
                    <Card>
                        ...
                        <Card.Body>
                            ...
                            <OverlayTrigger placement="top" overlay={<Tooltip id={`tooltip-top`}>
                ...
                <Col md={6}>
                    <Card>
                        ...
                        <Card.Body>
                            <OverlayTrigger trigger="click" placement="top" overlay={<Popover id={`popover-positioned-top`} title={`Popover on top`}>
                                        top by popover
                                    </Popover>}>
                                <Button variant="light">Top</Button>
                            </OverlayTrigger>
                            <OverlayTrigger trigger="click" placement="left" overlay={<Popover id={`popover-positioned-left`} title={`Popover on left`}>
                                        left by popover
                                    </Popover>}>
                                <Button variant="primary">Left</Button>
                            </OverlayTrigger>
                            <OverlayTrigger trigger="click" placement="right" overlay={<Popover id={`popover-positioned-right`} title={`Popover on right`}>
                                        right by popover
                                    </Popover>}>
                                <Button variant="success">Right</Button>
                            </OverlayTrigger>
                            <OverlayTrigger trigger="click" placement="bottom" overlay={<Popover id={`popover-positioned-bottom`} title={`Popover on bottom`}>
                                        bottom by popover
                                    </Popover>}>
                                <Button variant="warning">Bottom</Button>
                            </OverlayTrigger>
        ...
        // @ts-ignore
        <Popover id={`popover-positioned-html`} title={htmlTitle}>
                                        popover by HTML
                                    </Popover>}>
