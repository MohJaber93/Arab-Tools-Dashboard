    ...
    return (<>
            <Row>
                <Col>
                    <Card>
                        <Card.Header>
                            <Card.Title as="h5">Basic Tabs</Card.Title>
                        </Card.Header>
                        <Card.Body>
                    ...
                    <Card>
                        <Card.Header>
                            <Card.Title as="h5">Basic Pills</Card.Title>
                        </Card.Header>
                        <Card.Body>
                    ...
                    <Card>
                        <Card.Header>
                            <Card.Title as="h5">Vertical Pills</Card.Title>
                        </Card.Header>
                        <Card.Body>
                                    ...
                                    <Col sm={9}>
                                        <Tab.Content>
                                            ...
                                            <Tab.Pane eventKey="settings">
                                                <p>
                                                    Eu dolore ea ullamco dolore Lorem id cupidatat excepteur reprehenderit consectetur elit
                                                    ...
                                                    in aute tempor commodo eiusmod.
                                                </p>
                                            </Tab.Pane>
                                        </Tab.Content>
                                    </Col>
