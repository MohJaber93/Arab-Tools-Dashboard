...
const BreadcrumbPagination = () => {
    ...
    for (let number = 1; number <= 5; number++) {
        activeItems.push(<Pagination.Item key={number} active={number === active}>
                {number}
            </Pagination.Item>);
    }
    for (let number = 1; number <= 5; number++) {
        disabledItems.push(<Pagination.Item key={number} disabled={number === disabled}>
                {number}
            </Pagination.Item>);
    }
    return (<>
            <Row>
                <Col md={6}>
                    <Card title="Breadcrumb">
                        <Breadcrumb>
                            <Breadcrumb.Item href={DEMO.BLANK_LINK} active>
                                Home
                            </Breadcrumb.Item>
                        </Breadcrumb>
                        <Breadcrumb>
                ...
                <Col md={6}>
                    <Card title="Breadcrumb Icon">
                        ...
                        <Breadcrumb>
                            <Breadcrumb.Item href={DEMO.BLANK_LINK}>
                                <i className="feather icon-home"/>
                            </Breadcrumb.Item>
                            <Breadcrumb.Item href={DEMO.BLANK_LINK} active>
                                Library
