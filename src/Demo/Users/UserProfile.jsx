                            ...
                            <Col md={8} className="mt-md-4">
                                ...
                                <ul className="nav nav-tabs profile-tabs nav-fill" id="myTab" role="tablist">
                                    <li className="nav-item">
                                        <a className={data.activeProfileTab === 'home' ? profileTabActiveClass : profileTabClass} onClick={() => {
            setData({ ...data, activeProfileTab: 'home' });
        }} id="home-tab" href={DEMO.BLANK_LINK}>
                                            <i className="feather icon-home mr-2"/>
                                            Home
                                        </a>
                                    </li>
                                    <li className="nav-item">
                                        <a className={data.activeProfileTab === 'profile' ? profileTabActiveClass : profileTabClass} onClick={() => {
            setData({ ...data, activeProfileTab: 'profile' });
        }} id="profile-tab" href={DEMO.BLANK_LINK}>
                                            <i className="feather icon-user mr-2"/>
                                            Profile
                                        </a>
                                    </li>
                                    <li className="nav-item">
                                        <a className={data.activeProfileTab === 'contact' ? profileTabActiveClass : profileTabClass} onClick={() => {
            setData({ ...data, activeProfileTab: 'contact' });
        }} id="contact-tab" href={DEMO.BLANK_LINK}>
                                            <i className="feather icon-phone mr-2"/>
                                            My Contacts
                                        </a>
                                    </li>
                                    <li className="nav-item">
                                        <a className={data.activeProfileTab === 'gallery' ? profileTabActiveClass : profileTabClass} onClick={() => {
            setData({ ...data, activeProfileTab: 'gallery' });
        }} id="gallery-tab" href={DEMO.BLANK_LINK}>
                                            <i className="feather icon-image mr-2"/>
                                            Gallery
                                        </a>
                                    </li>
            ...
            <Row>
                <Col md={8} className="order-md-2">
                    <div className="tab-content">
                        <div className={data.activeProfileTab === 'home' ? profilePanActiveClass : profilePanClass} id="home">
                            <Card>
                                <Card.Header>
                                    <h5 className="font-weight-normal">
                                        <a href={DEMO.BLANK_LINK} className="text-h-primary text-reset">
                                ...
                                <Card.Body className="border-top border-bottom">
                                    <ul className="list-inline m-0">
                                        <li className="list-inline-item">
                                            <a href={DEMO.BLANK_LINK} className="text-danger text-h-danger">
                                                <i className="feather icon-heart-on mr-2"/>
                                                Like
                                            </a>
                                        </li>
                                        <li className="list-inline-item">
                                            <a href={DEMO.BLANK_LINK} className="text-muted text-h-primary">
                                    ...
                                    <div className="media mb-0">
                                        ...
                                        <div className="media-body">
                                            ...
                                            <p className="m-b-0">
                                                ...
                                                <a href={DEMO.BLANK_LINK} className="text-muted text-h-danger ml-1">
                                                    <small>Like</small>
                                                </a>
                                                <a href={DEMO.BLANK_LINK} className="text-muted text-h-primary ml-1">
                                                    <small>Comment</small>
                                                </a>
                                            </p>
                                        </div>
                            ...
                            <Card>
                                ...
                                <Card.Body className="border-top border-bottom">
                                    <ul className="list-inline m-0">
                                        <li className="list-inline-item">
                                            <a href={DEMO.BLANK_LINK} className="text-muted text-h-danger">
                                                <i className="feather icon-heart-on mr-2"/>
                                                Like
                                            </a>
                                        </li>
                        ...
                        <div className={data.activeProfileTab === 'profile' ? profilePanActiveClass : profilePanClass} id="profile">
                            <Card>
                                <Card.Body className="d-flex align-items-center justify-content-between">
                                    ...
                                    <button type="button" className="btn btn-primary btn-sm rounded m-0 float-right" onClick={() => setData({ ...data, isPersonalEdit: !data.isPersonalEdit })}>
                                        <i className={data.isPersonalEdit ? 'feather icon-x' : 'feather icon-edit'}/>
                                    </button>
                                </Card.Body>
                                <Card.Body className={data.isPersonalEdit ? 'border-top pro-det-edit collapse' : 'border-top pro-det-edit collapse show'}>
                                ...
                                <Card.Body className={data.isPersonalEdit ? 'border-top pro-det-edit collapse show' : 'border-top pro-det-edit collapse'}>
                                    <Row className="form-group">
                                        <label className="col-sm-3 col-form-label font-weight-bolder">Full Name</label>
                                        <Col sm={9}>
                                    ...
                                    <Row className="form-group">
                                        ...
                                        <Col sm={9}>
                                            <button type="submit" className="btn btn-primary" onClick={() => setData({ ...data, isPersonalEdit: !data.isPersonalEdit })}>
                                                Save
                                            </button>
                                        </Col>
                                    </Row>
                            ...
                            <Card>
                                <Card.Body className="d-flex align-items-center justify-content-between">
                                    ...
                                    <button type="button" className="btn btn-primary btn-sm rounded m-0 float-right" onClick={() => setData({ ...data, isContactEdit: !data.isContactEdit })}>
                                        <i className={data.isContactEdit ? 'feather icon-x' : 'feather icon-edit'}/>
                                    </button>
                                </Card.Body>
                                <Card.Body className={data.isContactEdit ? 'border-top pro-det-edit collapse' : 'border-top pro-det-edit collapse show'}>
                                    <Row className="form-group">
                                ...
                                <Card.Body className={data.isContactEdit ? 'border-top pro-det-edit collapse show' : 'border-top pro-det-edit collapse'}>
                                    <Row className="form-group">
                                        <label className="col-sm-3 col-form-label font-weight-bolder">Mobile Number</label>
                                        <Col sm={9}>
                                    ...
                                    <Row className="form-group">
                                        <label className="col-sm-3 col-form-label"/>
                                        <Col sm={9}>
                                            <button type="submit" className="btn btn-primary" onClick={() => setData({ ...data, isContactEdit: !data.isContactEdit })}>
                                                Save
                                            </button>
                                        </Col>
                                    </Row>
                            ...
                            <Card>
                                <Card.Body className="d-flex align-items-center justify-content-between">
                                    ...
                                    <button type="button" className="btn btn-primary btn-sm rounded m-0 float-right" onClick={() => setData({ ...data, isOtherEdit: !data.isOtherEdit })}>
                                        <i className={data.isOtherEdit ? 'feather icon-x' : 'feather icon-edit'}/>
                                    </button>
                                </Card.Body>
                                <Card.Body className={data.isOtherEdit ? 'border-top pro-det-edit collapse' : 'border-top pro-det-edit collapse show'}>
                                    <Row className="form-group">
                                    ...
                                    <Row className="form-group">
                                        ...
                                        <Col sm={9}>Phoenixcoded</Col>
                                    </Row>
                                </Card.Body>
                                <Card.Body className={data.isOtherEdit ? 'border-top pro-det-edit collapse show' : 'border-top pro-det-edit collapse'}>
                                    <Row className="form-group">
                                        <label className="col-sm-3 col-form-label font-weight-bolder">Occupation</label>
                                        <Col sm={9}>
                                    ...
                                    <Row className="form-group">
                                        <label className="col-sm-3 col-form-label"/>
                                        <Col sm={9}>
                                            <button type="submit" className="btn btn-primary" onClick={() => setData({ ...data, isOtherEdit: !data.isOtherEdit })}>
                                                Save
                                            </button>
                                        </Col>
                                    </Row>
                        ...
                        <div className={data.activeProfileTab === 'contact' ? profilePanActiveClass : profilePanClass} id="contact">
                            <Row>
                                <Col md={6}>
                                            ...
                                            <div className="user-about-block text-center">
                                                <Row className="align-items-end">
                                                    <Col className="text-left pb-3">
                                                        <a href={DEMO.BLANK_LINK} className="text-c-yellow">
                                    ...
                                    <Card className="user-card user-card-1">
                                        ...
                                        <Card.Body className="hover-data text-white btn-page">
                                            <div className="">
                                                ...
                                                <button type="button" className="btn waves-effect waves-light btn-warning">
                                                    <i className="feather icon-link"/> Meating
                                                </button>
                                                <button type="button" className="btn waves-effect waves-light btn-danger">
                        ...
                        <div className={data.activeProfileTab === 'gallery' ? profilePanActiveClass : profilePanClass} id="gallery">
                            <Gallery images={[
                    ...
                    <Card>
                        ...
                        <Card.Body>
                            <ul className="list-inline">
                                <li className="list-inline-item">
                                    <a href={DEMO.BLANK_LINK}>
                                        <img src={avatar1} alt="user" className="img-radius mb-2 wid-50" data-toggle="tooltip" title="Joseph William"/>
                                    </a>
                                </li>
                                <li className="list-inline-item">
                                    <a href={DEMO.BLANK_LINK}>
                                        <img src={avatar2} alt="user" className="img-radius mb-2 wid-50" data-toggle="tooltip" title="Sara Soudein"/>
                                    </a>
                                </li>
                                <li className="list-inline-item">
                                    <a href={DEMO.BLANK_LINK}>
                                        <img src={avatar3} alt="user" className="img-radius mb-2 wid-50" data-toggle="tooltip" title="John Doe"/>
                                    </a>
                                </li>
                                <li className="list-inline-item">
                                    <a href={DEMO.BLANK_LINK}>
                                        <img src={avatar4} alt="user" className="img-radius mb-2 wid-50" data-toggle="tooltip" title="Joseph William"/>
                                    </a>
                                </li>
                                <li className="list-inline-item">
                                    <a href={DEMO.BLANK_LINK}>
                                        <img src={avatar5} alt="user" className="img-radius wid-50" data-toggle="tooltip" title="Sara Soudein"/>
                                    </a>
                                </li>
                                <li className="list-inline-item">
                                    <a href={DEMO.BLANK_LINK}>
                                        <img src={avatar1} alt="user" className="img-radius wid-50" data-toggle="tooltip" title="Joseph William"/>
                                    </a>
                                </li>
                                <li className="list-inline-item">
                                    <a href={DEMO.BLANK_LINK}>
                                        <img src={avatar2} alt="user" className="img-radius wid-50" data-toggle="tooltip" title="Sara Soudein"/>
                                    </a>
                                </li>
                                <li className="list-inline-item">
                                    <a href={DEMO.BLANK_LINK}>
                                        <img src={avatar3} alt="user" className="img-radius wid-50" data-toggle="tooltip" title="John Doe"/>
                                    </a>
                                </li>
                            </ul>
                        </Card.Body>
