                                        ...
                                        <Card.Body className="pt-0">
                                            ...
                                            <ul className="list-inline f-20 mt-3 mb-0">
                                                <li className="list-inline-item">
                                                    <a href={DEMO.BLANK_LINK} className="text-facebook">
                                                        <i className="fab fa-facebook-f"/>
                                                    </a>
                                                </li>
                                                <li className="list-inline-item">
                                                    <a href={DEMO.BLANK_LINK} className="text-twitter">
                                                        <i className="fab fa-twitter"/>
                                                    </a>
                                                </li>
                                                <li className="list-inline-item">
                                                    <a href={DEMO.BLANK_LINK} className="text-dribbble">
                                                        <i className="fab fa-dribbble"/>
                                                    </a>
                                                </li>
                                                <li className="list-inline-item">
                                                    <a href={DEMO.BLANK_LINK} className="text-pinterest">
                                                        <i className="fab fa-pinterest"/>
                                                    </a>
                                                </li>
                                                <li className="list-inline-item">
                                                    <a href={DEMO.BLANK_LINK} className="text-youtube">
                                                        <i className="fab fa-youtube"/>
                                                    </a>
                                                </li>
                                                <li className="list-inline-item">
                                                    <a href={DEMO.BLANK_LINK} className="text-googleplus">
                                                        <i className="fab fa-google-plus-g"/>
                                                    </a>
                                                </li>
                                                <li className="list-inline-item">
                                                    <a href={DEMO.BLANK_LINK} className="text-linkedin">
                                    ...
                                    <Card>
                                        ...
                                        <Card.Footer>
                                            <Row className="align-items-center">
                                                ...
                                                <Col sm="auto">
                                                    <button className="btn waves-effect waves-light btn-secondory btn-sm m-0">
                                                        Follow
                                                    </button>
                                                </Col>
                                            </Row>
