...
import CkInlineEditor from '../../../App/components/CkEditor/CkInlineEditor';
const EditorCkInline = () => {
    ...
    return (<>
            <Row>
                <Col>
                    <Card>
                        <Card.Header>
                            <Card.Title as="h5">Inline Editor</Card.Title>
                        </Card.Header>
                        <Card.Body>
                            <CkInlineEditor html={html} editor="inline"/>
                        </Card.Body>
                    </Card>
                </Col>
            </Row>
