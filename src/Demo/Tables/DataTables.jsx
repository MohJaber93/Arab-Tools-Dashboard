            ...
            <Row>
                <Col>
                    ...
                    <Card>
                        ...
                        <Card.Body>
                            <Table striped hover responsive bordered className="table table-condensed" id="datatable-column-order">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Name</th>
                    ...
                    <Card>
                        ...
                        <Card.Body>
                            <Table striped hover responsive bordered className="table table-condensed" id="data-table-fixed-Column">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Name</th>
                    ...
                    <Card>
                        ...
                        <Card.Body>
                            <Table striped hover responsive bordered className="table table-condensed" id="data-table-fixed-header">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Name</th>
                    ...
                    <Card>
                        ...
                        <Card.Body>
                            <Table striped hover responsive bordered className="table table-condensed" id="data-table-scroll">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Name</th>
