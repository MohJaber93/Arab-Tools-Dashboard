...
const FormsElements = () => {
    ...
    const handleSubmitTooltip = (event) => {
        ...
        setData({ ...data, validatedTooltip: true });
    };
    const supportedSelectHandler = (event) => {
        setData({ ...data, supportedSelect: parseInt(event.target.value) });
    };
    const supportedFileHandler = (event) => {
        setData({ ...data, supportedFile: !!event.target.value });
    };
    const { validated, validatedTooltip } = data;
    return (<>
            <Row>
                <Col>
                    <Card>
                        ...
                        <Card.Body>
                            ...
                            <Row>
                                <Col>
                                    <Form.Group>
                                        <Form.Check custom required isInvalid={!data.supportedCheckbox} isValid={data.supportedCheckbox} type="checkbox" id="supported-checkbox" label="Check this custom checkbox" feedback={data.supportedCheckbox ? false : 'Example invalid feedback text.'} onChange={() => setData((prevState) => {
            return { ...prevState, supportedCheckbox: !prevState.supportedCheckbox };
        })}/>
                                    </Form.Group>
                                    <Form.Group>
                                        <Form.Check custom required isInvalid={!data.supportedRadio} isValid={data.supportedRadio} type="radio" label="Toggle this custom radio" name="supportedRadio" id="supportedRadio1" onChange={() => setData({ ...data, supportedRadio: true })}/>
                                        <Form.Check custom required isInvalid={!data.supportedRadio} isValid={data.supportedRadio} type="radio" label="Or toggle this other custom radio" name="supportedRadio" id="supportedRadio2" feedback={data.supportedRadio ? false : 'More example invalid feedback text.'} onChange={() => setData({ ...data, supportedRadio: true })}/>
                                    </Form.Group>
                                    <Form.Group className="mt-3">
                                        <Form.Control as="select" required value={data.supportedSelect} isInvalid={data.supportedSelect === 0} isValid={data.supportedSelect !== 0} onChange={supportedSelectHandler}>
                                            <option value={0}>Open this select menu</option>
                                            <option value={1}>1</option>
                                            <option value={2}>2</option>
                                            <option value={3}>3</option>
                                        </Form.Control>
                                        {data.supportedSelect ? ('') : (<div className="invalid-feedback">Example invalid custom select feedback</div>)}
                                    </Form.Group>
                                    <div className="custom-file">
                                        <Form.Control type="file" className="custom-file-input" id="validatedCustomFile" required isInvalid={!data.supportedFile} isValid={data.supportedFile} onChange={supportedFileHandler}/>
                                        <Form.Label className="custom-file-label" htmlFor="validatedCustomFile">
                                            Choose file...
                                        </Form.Label>
                                        {data.supportedFile ? ('') : (<div className="invalid-feedback">Example invalid custom file feedback</div>)}
                                    </div>
                                </Col>
                            </Row>
                            ...
                            <Row>
                                <Col>
                                    <Form noValidate validated={validatedTooltip}>
                                        ...
                                        <Form.Group>
                                            <Form.Check custom required label="Agree to terms and conditions" feedback="You must agree before submitting." id="tooltip-agree"/>
                                        </Form.Group>
                            ...
                            <Row>
                                ...
                                <Col md={6}>
                                    ...
                                    <hr />
                                    <Form.Group>
                                        <Form.Check custom type="radio" label="Toggle this custom radio" name="supportedRadios" id="supportedRadio3"/>
                                    ...
                                    <hr />
                                    <Form.Group>
                                        <Form.Check inline custom type="radio" label="Toggle this custom radio" name="supportedRadio" id="supportedRadio21"/>
                                        <Form.Check inline custom type="radio" label="Or toggle this other custom radio" name="supportedRadio" id="supportedRadio22"/>
                                    </Form.Group>
                                </Col>
                                <Col md={6}>
                            ...
                            <Row>
                                ...
                                <Col md={6}>
                                    ...
                                    <InputGroup className="mb-3">
                                        ...
                                        <div className="custom-file">
                                            <Form.Control aria-describedby="custom-addons5" type="file" className="custom-file-input" id="validatedCustomFile1"/>
