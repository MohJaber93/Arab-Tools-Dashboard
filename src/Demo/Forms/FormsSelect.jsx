            ...
            <Row>
                ...
                <Col md={6} xl={4}>
                    <Card>
                        ...
                        <Card.Body>
                            <Select closeMenuOnSelect={false} components={makeAnimated()} defaultValue={[colourOptions[4], colourOptions[5]]} isMulti options={colourOptions}/>
                        </Card.Body>
                    </Card>
                </Col>
                <Col md={6} xl={4}>
                    <Card>
                        ...
                        <Card.Body>
                            <Select defaultValue={colourOptions[2]} label="Single select" options={colourOptions} styles={colourStylesSingle}/>
                        </Card.Body>
                    </Card>
                </Col>
                <Col md={6} xl={4}>
                    <Card>
                        ...
                        <Card.Body>
                            <Select closeMenuOnSelect={false} defaultValue={[colourOptions[0], colourOptions[1]]} isMulti options={colourOptions} styles={colourStylesMulti}/>
                        </Card.Body>
                    </Card>
                </Col>
                <Col md={6} xl={4}>
