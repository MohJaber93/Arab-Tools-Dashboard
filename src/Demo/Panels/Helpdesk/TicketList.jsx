...
const TicketList = () => {
    ...
    const [gridSize, setGridSize] = useState('large-view');
    ...
    const deskClass = ['btn-page', 'help-desk', gridSize];
    ...
    return (<>
                ...
                <Col xl={8} lg={12}>
                        ...
                        <Card.Body>
                            <nav className="navbar justify-content-between p-0 align-items-center">
                                ...
                                <div className="btn-group btn-group-toggle">
                                    <label onClick={() => setGridSize('sm-view')} className={gridSize === 'sm-view' ? gridActiveClass : gridDefault}>
                                        <input type="radio" name="options" id="option1" defaultChecked={true}/>{' '}
                                        <i className="feather icon-align-justify m-0"/>
                                    </label>
                                    <label onClick={() => setGridSize('md-view')} className={gridSize === 'md-view' ? gridActiveClass : gridDefault}>
                                        <input type="radio" name="options" id="option1" defaultChecked={true}/>{' '}
                                        <i className="feather icon-menu m-0"/>
                                    </label>
                                    <label onClick={() => setGridSize('large-view')} className={gridSize === 'large-view' ? gridActiveClass : gridDefault}>
                                        <input type="radio" name="options" id="option1" defaultChecked={true}/>{' '}
                                        <i className="feather icon-grid m-0"/>
                                    </label>
                                </div>
                            </nav>
                        </Card.Body>
                    ...
                    <div className="ticket-block">
                        <Row className="row">
                            ...
                            <div className="col">
                                <div className="card hd-body" onClick={() => setIsOpen(true)}>
                                    <div className="row align-items-center">
                                        <div className="col border-right pr-0">
                                            <div className="card-body inner-center">
                                                ...
                                                <div className="ticket-type-icon private mt-1 mb-1">
                                                    <i className="feather icon-lock mr-1 f-14"/>
                                                ...
                                                <ul className="list-inline mt-2 mb-0">
                                                    ...
                                                    <li className="list-inline-item">
                                                        <i className="feather icon-message-square mr-1 f-14"/>9
                                                    </li>
                                                </ul>
                                                <div className="excerpt mt-4">
                                                    <h6>
                                                        <img src={avatar5} alt="" className="wid-20 avatar mr-2 rounded"/>
                                                        Last comment from <a href={DEMO.BLANK_LINK}>Robert alia:</a>
                                                    </h6>
                                                    <p>
                                                        hello John lui, you need to create "toolbar-options" div only once in a page&nbsp;in
                                                        your code, this div fill found every "td" tag in your page, just remove those
                                                        things. and also in option button add
                                                    </p>
                                                </div>
                                                <div className="mt-2">
                                                    <a href={DEMO.BLANK_LINK} className="mr-3 text-muted">
                                                        <i className="feather icon-eye mr-1"/>
                                                        View Ticket
                                                    </a>
                                                    <a href={DEMO.BLANK_LINK} className="text-danger">
                                        ...
                                        <div className="col-auto pl-0 right-icon">
                                            <div className="card-body">
                                                <ul className="list-unstyled mb-0">
                                                    <li>
                                                        <a href={DEMO.BLANK_LINK} data-toggle="tooltip" data-placement="top" title="" data-original-title="tooltip on top" className="active">
                                                            <i className="feather icon-star text-warning"/>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href={DEMO.BLANK_LINK} data-toggle="tooltip" data-placement="top" title="" data-original-title="tooltip on top">
                                                            <i className="feather icon-circle text-muted"/>
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
                                        ...
                                        <div className="col-auto hover-blk position-absolute shadow-sm rounded">
                                            <div className="card-body p-0 pt-2">
                                                ...
                                                <p>
                                                    hello Yogen dra,you need to create "toolbar-options" div only once in a page in your
                                                    code, this div fill found every "td"...
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="cat-list">
                                    <div className="border-bottom pb-3 ">
                                        ...
                                        <div className="float-right span-content">
                                            <a href={DEMO.BLANK_LINK} className="btn waves-effect waves-light btn-default badge-danger rounded-circle mr-1" data-toggle="tooltip" data-placement="top" title="" data-original-title="tooltip on top">
                                                1
                                            </a>
                                            <a href={DEMO.BLANK_LINK} className="btn waves-effect waves-light btn-default badge-secondary rounded-circle mr-0 " data-toggle="tooltip" data-placement="top" title="" data-original-title="tooltip on top">
                                                3
                                            </a>
                                        </div>
                                    </div>
            ...
            <Modal show={isOpen} onHide={() => setIsOpen(false)} className="qview-modal q-view-modal" scrollable={true}>
                <Modal.Header closeButton>
                    <Modal.Title as="h5">
                        Chrome bug The page uses a roller to slide
                        <span className="badge badge-danger text-uppercase ml-2 f-12">Private</span>
                    </Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <Card.Body>
                        <div className="border-bottom pb-3 pt-3">
                            <div className="row">
                                <div className="col-md-7">
                                    <button type="button" className="btn waves-effect waves-light btn-outline-success btn-sm mr-1">
                                        <i className="feather icon-check mr-1"/> Closed
                                    </button>
                    ...
                    <Col sm={12}>
                        <Card className="border-0 shadow-none">
                                ...
                                <Row>
                                    ...
                                    <Col>
                                        <div className="tab-block border-bottom mb-4 pb-3">
                                            <h5>
                                                <i className="feather icon-corner-up-left mr-1"/>
                                                Reply
                                            </h5>
                                        </div>
                                        <p className="text-danger">
                                            <span className="font-weight-bold mr-1">Note!</span>This ticket is closed. If you want to
                                            re-open it, just post a reply below.
                                        </p>
                            ...
                            <Row className="border-bottom border-top pb-3 pt-4 pl-3 pr-3">
                                ...
                                <Col>
                                    <h6 className="mb-0">
                                        Support Agent name<span className="badge badge-secondary ml-2">Support Agent</span>
                                    </h6>
                                ...
                                <Col sm="auto">
                                    <ul className="list-unstyled mb-0">
                                        ...
                                        <li className="d-inline-block">
                                            <a href={DEMO.BLANK_LINK}>
                                                <i className="feather icon-trash-2 text-muted"/>
                                            </a>
                                        </li>
                                    </ul>
                                </Col>
                                <Col sm={12} className="mt-3">
                                    <div className="comment-content">
                                        <p>hello John lui,</p>
                                        <p>
                                            you need to create <strong>"toolbar-options" div only once</strong> in a page in your code, this
                                            div fill found
                                            <strong>every "td"</strong> tag in your page, just remove those things.
                                        </p>
                                        <p>and also</p>
                                        <p>
                                            in option button add "<strong>p-0</strong>" class in "<strong>I</strong>" tag
                                        </p>
                                        <p>to</p>
                                        <p />
                                        <p>Thanks...</p>
