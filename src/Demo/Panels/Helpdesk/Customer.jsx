                ...
                <Col sm={12}>
                        ...
                        <Card.Header>
                            ...
                            <div className="card-header-right">
                                <Button variant="success" className="btn-sm btn-round has-ripple" onClick={() => setIsOpen(true)}>
                                    <i className="feather icon-plus"/> Add Customers
                                </Button>
                            </div>
                        </Card.Header>
                            ...
                            <Table responsive hover>
                                ...
                                <tbody>
                                    <tr>
                                        <td>Mark Jason</td>
                                        <td>
                                            <a href={DEMO.BLANK_LINK}>mark@mark.com</a>
                                        </td>
                                        <td>N/A</td>
                                ...
                                <nav aria-label="Page navigation example" className="d-inline-block">
                                    <ul className="pagination">
                                        <li className="page-item">
                                            <a className="page-link" href={DEMO.BLANK_LINK}>
                                                Previous
                                            </a>
                                        </li>
                                        <li className="page-item">
                    ...
                    <Modal show={isOpen} onHide={() => setIsOpen(false)}>
                        <Modal.Header closeButton>
                            <Modal.Title as="h5">
                                <i className="feather icon-user"/> Add Customer
                            </Modal.Title>
                        </Modal.Header>
                        <Modal.Body>
                            <Row>
