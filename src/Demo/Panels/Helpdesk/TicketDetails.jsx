...
const TicketDetails = () => {
    const basicCode = `<div className="card">
                            ...
                            <Row className="align-items-center">
                                ...
                                <Col md={4}>
                                    <div className="btn-star">
                                        <a href={DEMO.BLANK_LINK} className="btn waves-effect waves-light btn-primary btn-sm mr-1">
                                            Mark as unread
                                        </a>
                                        <a href={DEMO.BLANK_LINK}>
                                            <i className="feather icon-star f-20 text-muted"/>
                                        </a>
                                    </div>
                                </Col>
                            </Row>
                            ...
                            <Row className="align-items-center">
                                <Col className="btn-page">
                                    <button type="button" className="btn btn-secondary text-uppercase">
                                        <i className="mr-2 feather icon-message-square"/>
                                        Post a reply
                                    </button>
                                    <button type="button" className="btn btn-secondary text-uppercase">
                                        <i className="mr-2 feather icon-edit"/>
                                        Post a Note
                                    </button>
                                    <button type="button" className="btn btn-secondary text-uppercase">
                                        <i className="mr-2 feather icon-user-check"/>
                                        Customer Notes
                                    </button>
                                </Col>
                            </Row>
                        ...
                        <Card.Body className="hd-detail hdd-admin border-bottom">
                            <Row>
                                <Col sm="auto">
                                    ...
                                    <p>
                                        <i className="fas fa-thumbs-up mr-1 text-primary"/>4
                                    </p>
                                </Col>
                                <Col>
                                    ...
                                    <Card.Body className="text-center">
                                        <ul className="list-unstyled mb-0 edit-del">
                                            <li className="d-inline-block f-20 mr-1">
                                                <a href={DEMO.BLANK_LINK}>
                                                    <i className="feather icon-edit-2 text-muted"/>
                                                </a>
                                            </li>
                    ...
                    <Card className="hdd-right-inner">
                        ...
                        <Card.Body>
                            <div className="alert alert-success d-block text-center text-uppercase">
                                <i className="feather icon-check-circle mr-2"/>
                                Verified Purchase
                            </div>
                        ...
                        <ul className="list-group list-group-flush">
                                ...
                                <div className="media align-items-center">
                                    ...
                                    <div className="media-body">
                                        <p className="mb-0">
                                            ...
                                            <a href={DEMO.BLANK_LINK}>Jack Pall</a>
                                        </p>
                                    </div>
                                </div>
                            </li>
                            <li className="list-group-item">
                                <div className="media align-items-center">
                                    ...
                                    <div className="media-body">
                                        <p className="mb-0">
                                            <i className="feather icon-mail mr-1"/>
                                            <a href={DEMO.BLANK_LINK}>mail@mail.com</a>
                                        </p>
                                    </div>
                                </div>
                            </li>
                                ...
                                <div className="media align-items-center">
                                    ...
                                    <div className="media-body">
                                        <p className="mb-0">
                                            ...
                                            <a href={DEMO.BLANK_LINK}>Lina Hop</a>
                                        </p>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li className="list-group-item py-3">
                                <button type="button" className="btn btn-primary">
                                    <i className="m-r-5 feather icon-thumbs-up"/>
                                    Make Private
                                </button>
                                <button type="button" className="btn btn-danger">
                                    <i className="m-r-5 feather icon-trash-2"/>
                                    Delete
                                </button>
                            </li>
                        </ul>
