...
const Dashboard = () => {
    ...
    return (<>
                            ...
                            <ul className="list-unstyled task-list">
                                <li>
                                    ...
                                    <h6 className="text-muted">
                                        Your first semester Exam will held on <span className="text-c-blue">19-04-2018</span>.
                                    </h6>
                                </li>
                                <li>
                                    ...
                                    <h6 className="text-muted">
                                        In your school campus on <span className="text-c-blue">1-03-2018</span> will held a program of{' '}
                                        <span className="text-c-blue">annual sports day</span>.You are all invited.
                                    </h6>
                                </li>
                                <li>
                                    ...
                                    <h6 className="text-muted">
                                        Your second semester exam will held on 30-08-2018.Please be prepare for your exam
                                    </h6>
                                </li>
                                <li>
                                    ...
                                    <h6 className="text-muted">
                                        On <span className="text-c-blue">20-11-2018</span> will held a programming contest in school
                                        campus.Registration start from today.{' '}
                                    </h6>
                                </li>
                                <li className="pb-2 mb-0">
                                    ...
                                    <h6 className="text-muted">
                                        Prize giving ceremony will held on <span className="text-c-blue">03-01-2019</span>.Best Student List
        ...
        }} initialView="dayGridMonth" editable={true} selectable={true} selectMirror={true} dayMaxEvents={true} weekends={true} initialDate="2018-08-12" events={event} // alternatively, use the `events` setting to fetch from a feed
    />
                        </Card.Body>
                    </Card>
                </Col>
