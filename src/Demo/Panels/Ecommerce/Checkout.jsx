...
import { Row, Col, Table, Card, Tab, Nav, Collapse } from 'react-bootstrap';
                                                ...
                                                <Card className="border mb-0 shadow-none">
                                                    <Card.Body>
                                                        <div className="custom-control custom-radio">
                                                            ...
                                                            <label className="custom-control-label font-weight-bold" htmlFor="radiohome">
                                                                Home
                                                            </label>
                                                        </div>
                                                        <br />
                                                        ...
                                                        <p className="mb-0">
                                                            <a className="text-secondary" href="mailto:demo@sample.com" target="_top">
                                                                demo@sample.com
                                                            </a>
                                                        </p>
                                                    </Card.Body>
                                                ...
                                                <Card className="border mb-0 shadow-none">
                                                    <Card.Body>
                                                        <div className="custom-control custom-radio">
                                                            ...
                                                            <label className="custom-control-label font-weight-bold" htmlFor="radiooffice">
                                                                Office
                                                            </label>
                                                        </div>
                                                        <br />
                                ...
                                <Card>
                                    <Card.Header>
                                        ...
                                        <p className="text-muted mb-0">
                                            Fill the form below in for your new address in wich we send you the order's invoice.
                                        </p>
                                    </Card.Header>
                                        ...
                                        <Row>
                                            ...
                                            <Col md={12}>
                                                ...
                                                <div className="custom-control custom-radio custom-control-inline" data-toggle="tooltip" title="Estimated 5-7 days shipping (Duties and tax may be due upon delivery)">
                                                    ...
                                                    <label className="custom-control-label font-weight-bold" htmlFor="shippingMethodRadio1">
                                                ...
                                                <div className="custom-control custom-radio custom-control-inline" data-toggle="tooltip" title="Estimated 1-2 days shipping (Duties and tax may be due upon delivery)">
                                                    ...
                                                    <label className="custom-control-label font-weight-bold" htmlFor="shippingMethodRadio2">
                                                        Fast Delivery - $29
                                                    </label>
                                                </div>
                                            </Col>
                            ...
                            <Tab.Pane eventKey="pi">
                                <div className="accordion">
                                    ...
                                    <Card className="mb-0 shadow-none border-top">
                                        <Card.Header>
                                            <div className="custom-control custom-radio">
                                                <input type="radio" id="BillingPaypal" onClick={() => setAccordionKey(accordionKey !== 1 ? 1 : 0)} name="billingOptions" className="custom-control-input" aria-controls="accordion1"/>
                                                <label className="custom-control-label font-weight-bold" htmlFor="BillingPaypal">
                                                    Pay with Paypal
                                                </label>
                                            </div>
                                        </Card.Header>
                                    ...
                                    <Card className="mb-0 shadow-none border-top">
                                        <Card.Header>
                                            <div className="custom-control custom-radio">
                                                <input type="radio" id="BillingCard" onClick={() => setAccordionKey(accordionKey !== 2 ? 2 : 0)} name="billingOptions" className="custom-control-input" aria-controls="accordion2"/>
                                                <label className="custom-control-label font-weight-bold" htmlFor="BillingCard">
                                                    Credit / Debit Card
                                                </label>
                                            </div>
                                        </Card.Header>
                                            ...
                                            <div id="accordion2">
                                                <Card.Body className="bg-light">
                                                    <Row>
                                                        <Col sm={8}>
                                                            <p className="mb-0 pl-3 pt-1">
                                                                Safe money transfer using your bank account. We support Mastercard, Visa,
                                                                Discover and Stripe.
                                                            </p>
                                                        </Col>
                                                        <Col sm={4} className="text-sm-right mt-3 mt-sm-0">
                                    ...
                                    <Card className="mb-0 shadow-none border-top">
                                        <Card.Header>
                                            <div className="custom-control custom-radio">
                                                <input type="radio" id="BillingOptRadio3" onClick={() => setAccordionKey(accordionKey !== 3 ? 3 : 0)} name="billingOptions" className="custom-control-input" aria-controls="accordion1"/>
                                                <label className="custom-control-label font-weight-bold" htmlFor="BillingOptRadio3">
                                                    Pay with CC Avenue
                                                </label>
                                            </div>
                                        </Card.Header>
                                            ...
                                            <div id="accordion1">
                                                <Card.Body>
                                                    <Row>
                                                        <Col sm={8}>
                                                            <p className="mb-0 pl-3 pt-1">
                                                                You will be redirected to CC Avenue website to complete your purchase
                                                                securely.
                                                            </p>
                                                        </Col>
                                                        <Col sm={4} className="text-sm-right mt-3 mt-sm-0">
                                    ...
                                    <Card className="mb-0 shadow-none border-top">
                                        <Card.Header>
                                            <div className="custom-control custom-radio">
                                                <input type="radio" id="BillingOptRadio4" onClick={() => setAccordionKey(accordionKey !== 4 ? 4 : 0)} name="billingOptions" className="custom-control-input" aria-controls="accordion1"/>
                                                <label className="custom-control-label font-weight-bold" htmlFor="BillingOptRadio4">
                                                    Cash on Delivery
                                                </label>
                                            </div>
                                        </Card.Header>
                                    ...
                                    <Card className="mb-0 shadow-none border-top">
                                        <Card.Header>
                                            <div className="row justify-content-between">
                                                <div className="col">
                                                    <div className="custom-control custom-radio">
                                                        <input type="radio" id="BillingOptRadio5" onClick={() => setAccordionKey(accordionKey !== 5 ? 5 : 0)} name="billingOptions" className="custom-control-input" aria-controls="accordion1" disabled/>
                                                        <label className="custom-control-label font-weight-bold" htmlFor="BillingOptRadio5">
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <p className="m-0 d-inline-block align-middle">
                                                        <a href={DEMO.BLANK_LINK} className="text-body font-weight-semibold">
                                                            Rolling Chair
                                                        </a>
                                                        <br />
                                                ...
                                                <td className="text-right">$743.00</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                            ...
                            <Table responsive className="table-borderless mb-0 w-auto table-sm float-right text-right">
                                <tbody>
                                    ...
                                    <tr className="border-top">
                                        ...
                                        <td className="font-weight-semibold">$1070</td>
                                    </tr>
                                </tbody>
                            </Table>
                        </Card.Body>
