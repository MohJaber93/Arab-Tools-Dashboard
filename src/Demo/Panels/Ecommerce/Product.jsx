                            ...
                            <Table striped hover responsive id="data-table-zero">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td className="align-middle">Office Chairs</td>
                                        <td className="align-middle">16/12/2019</td>
                                        <td className="align-middle">$597.66</td>
                                        ...
                                        <td className="table-action">
                                            <a href={DEMO.BLANK_LINK} className="btn btn-icon btn-outline-primary">
                                                <i className="feather icon-eye"/>
                                            </a>
                                            <a href={DEMO.BLANK_LINK} className="btn btn-icon btn-outline-success">
                                                <i className="feather icon-edit"/>
                                            </a>
                                            <a href={DEMO.BLANK_LINK} className="btn btn-icon btn-outline-danger">
                                    ...
                                    <tr>
                                        ...
                                        <td className="align-middle">Wooden Chairs</td>
                                        <td className="align-middle">28/01/2019</td>
                                        <td className="align-middle">$63.56</td>
                                        <td className="align-middle">236</td>
                                        <td className="align-middle">
                                            <span className="badge badge-success">Active</span>
                                        </td>
                                        <td className="table-action">
                                    ...
                                    <tr>
                                        ...
                                        <td className="align-middle">Man cloths</td>
                                        <td className="align-middle">08/23/2018</td>
                                    ...
                                    <tr>
                                        ...
                                        <td className="align-middle">Man cloths</td>
                                        <td className="align-middle">08/02/2018</td>
                                        <td className="align-middle">$49.54</td>
                                    ...
                                    <tr>
                                        ...
                                        <td className="align-middle">Woman cloths</td>
                                        <td className="align-middle">01/12/2018</td>
                                        <td className="align-middle">$58.57</td>

                                        <td className="align-middle">243</td>
                                        <td className="align-middle">
                                    ...
                                    <tr>
                                        ...
                                        <td className="align-middle">Man cloths</td>
                                        <td className="align-middle">12/04/2019</td>
                                        <td className="align-middle">$45.26</td>
                                        <td className="align-middle">350</td>
                                        <td className="align-middle">
                                            <span className="badge badge-success">Active</span>
                                        </td>
                                        <td className="table-action">
                                    ...
                                    <tr>
                                        ...
                                        <td className="align-middle">Woman cloths</td>
                                        <td className="align-middle">06/30/2018</td>
                                        <td className="align-middle">$76</td>

                                        <td className="align-middle">560</td>
                                        <td className="align-middle">
                                            <span className="badge badge-danger">Deactive</span>
                                        </td>
                                        <td className="table-action">
                                    ...
                                    <tr>
                                        ...
                                        <td className="align-middle">Kids cloths</td>
                                        <td className="align-middle">06/13/2019</td>
                                    ...
                                    <tr>
                                        ...
                                        <td className="align-middle">Woman cloths</td>
                                        <td className="align-middle">05/02/2019</td>
                                    ...
                                    <tr>
                                        ...
                                        <td className="align-middle">Travel bag</td>
                                        <td className="align-middle">04/09/2019</td>
                                        <td className="align-middle">$78.66</td>
                                        <td className="align-middle">12</td>
                                        <td className="align-middle">
                                            <span className="badge badge-danger">Deactive</span>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td className="align-middle">Man watch</td>
                                        <td className="align-middle">03/24/2019</td>
                                        <td className="align-middle">$5</td>
                                        <td className="align-middle">204</td>
                                        <td className="align-middle">
                                            <span className="badge badge-danger">Deactive</span>
                                        </td>
                                        <td className="table-action">
                                    ...
                                    <tr>
                                        ...
                                        <td className="align-middle">Woman cloath</td>
                                        <td className="align-middle">09/05/2019</td>
                                        <td className="align-middle">$2.24</td>
                                        <td className="align-middle">541</td>
                                        <td className="align-middle">
                                            <span className="badge badge-success">Active</span>
                                        </td>
                                        <td className="table-action">
