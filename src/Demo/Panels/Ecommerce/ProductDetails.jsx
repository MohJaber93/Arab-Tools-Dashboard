                            ...
                            <Row>
                                <Col lg={5}>
                                    <div id="carouselExampleCaptions" className="carousel slide carousel-fade">
                                        ...
                                        <ol className="carousel-indicators position-relative">
                                            <li data-target="#carouselExampleCaptions" data-slide-to="0" onClick={() => setIsOpen(1)} className={isOpen === 1 ? productClassActive : productClass}>
                                                <img src={prod1} className="d-block wid-50" alt="Product"/>
                                            </li>
                                            <li data-target="#carouselExampleCaptions" data-slide-to="1" onClick={() => setIsOpen(2)} className={isOpen === 2 ? productClassActive : productClass}>
                                                <img src={prod2} className="d-block wid-50" alt="Product"/>
                                            </li>
                                            <li data-target="#carouselExampleCaptions" data-slide-to="2" onClick={() => setIsOpen(3)} className={isOpen === 3 ? productClassActive : productClass}>
                                                <img src={prod3} className="d-block wid-50" alt="Product"/>
                                            </li>
                                            <li data-target="#carouselExampleCaptions" data-slide-to="3" onClick={() => setIsOpen(4)} className={isOpen === 4 ? productClassActive : productClass}>
                                                <img src={prod4} className="d-block wid-50" alt="Product"/>
                                            </li>
                                            <li data-target="#carouselExampleCaptions" data-slide-to="4" onClick={() => setIsOpen(5)} className={isOpen === 5 ? productClassActive : productClass}>
                                ...
                                <Col lg={7}>
                                    <div className="pl-lg-4">
                                        ...
                                        <div className="mt-3">
                                            <h5>
                                                <span className="badge badge-success">Instock</span>
                                            </h5>
                                        </div>
                                        <div className="mt-4">
                                            <h6>Special price:</h6>
                                            <h3>
                                                $139.58{' '}
                                                <del className="text-muted font-weight-normal h5">
                                                    {' '}
                                                    <small>$322.53</small>
                                                </del>{' '}
                                                <small className="text-success h5">86% off</small>
                                            </h3>
                                            <h5>
                                                <span className="badge badge-success">
                                                    3.8 <i className="feather icon-star-on"/>
                                                </span>{' '}
                                                179 ratings and 43 reviews
                                            </h5>
                                        </div>
                                        <div className="mt-4">
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-sm-6 mt-md-0 mt-2">
                                                <h6>
                                                    <i className="feather icon-map-pin"/> Deliver to
                                                </h6>
                                                <div className="form-group fill">
                                                    <label className="floating-label" htmlFor="pincode">
                                            ...
                                            <div className="col-sm-6 mt-md-0 mt-2">
                                                <button type="button" className="btn btn-block btn-lg btn-warning">
                                                    <i className="fas fa-cart-plus mr-1"/> Add to cart
                                                </button>
                                            </div>
                                            <div className="col-sm-6">
                                                <button type="button" className="btn btn-block btn-lg btn-danger mt-md-0 mt-2">
                                                    <i className="fas fa-bolt mr-1"/> Buy now
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <Col lg={12}>
                                    <div className="mt-4">
                                        <h6>Description:</h6>
                                        <p>
                                            This stylish Sling Bag SAHAL FASHION from is best to carry to work to add an element of style to
                                            your office wear.Made from premium. It is compact to store your important things with ease.Made
                                            From outer material PU and inner material From Fabric. Furthermore, they feature Turnlock
                                            closure are best suited for a casual and partywear occasion.
                                        </p>
                                        <div className="w-100">
                                        ...
                                        <h6>
                                            <a href={DEMO.BLANK_LINK}>Manufacturing, Packaging and Import Info</a>
                                        </h6>
                                    </div>
                                </Col>
                            </Row>
