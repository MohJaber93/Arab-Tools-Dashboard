...
const Email = () => {
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="0" bgcolor="#F0F0F0" style="width: 78.6486%; margin-left: 10.2703%;">
        <tbody>
            <tr>
                <td style="background-color: #ffffff;" align="center" valign="top" bgcolor="#ffffff"><br>
                    <table style="width: 100.43%; max-width: 600px;" border="0" width="100%" cellspacing="0" cellpadding="0">
                        <tbody>
                            <tr>
                                <td height="30"> </td>
                            </tr>
                                ...
                                <Col sm={6}>
                                    <div className="form-group fill">
                                        <label className="floating-label" htmlFor="Name">
                                            <small className="text-danger">* </small>Template Name
                                        </label>
                                ...
                                <Col sm={6}>
                                    <div className="form-group fill">
                                        <label className="floating-label" htmlFor="Subject">
                                            <small className="text-danger">* </small>Subject
                                        </label>
