                ...
                <Col sm={4}>
                    <Card>
                        <Card.Body className="text-center">
                            ...
                            <p>
                                <span className="badge badge-primary">16 Sales</span>{' '}
                            </p>
                            <hr />
                            <button type="button" className="btn btn-icon btn-outline-primary mr-2" onClick={() => setIsOpen(true)}>
                ...
                <Col sm={4}>
                    <Card>
                        <Card.Body className="text-center">
                            ...
                            <p>
                                <span className="badge badge-primary">26 Sales</span>{' '}
                            </p>
                            <hr />
                            <button type="button" className="btn btn-icon btn-outline-primary mr-2" onClick={() => setIsOpen(true)}>
                                <i className="feather icon-edit-2"/>
                ...
                <Col sm={4}>
                    <Card>
                        <Card.Body className="text-center">
                            ...
                            <p>
                                <span className="badge badge-primary">29 Sales</span>{' '}
                            </p>
                            <hr />
                            <button type="button" className="btn btn-icon btn-outline-primary mr-2" onClick={() => setIsOpen(true)}>
                                <i className="feather icon-edit-2"/>
                ...
                <Col sm={4}>
                    <Card>
                        <Card.Body className="text-center">
                            ...
                            <p>
                                <span className="badge badge-primary">0 Sales</span>{' '}
                            </p>
                            <hr />
                            <button type="button" className="btn btn-icon btn-outline-primary mr-2" onClick={() => setIsOpen(true)}>
                                <i className="feather icon-edit-2"/>
            ...
            <Modal size="lg" show={isOpen} onHide={() => setIsOpen(false)}>
                ...
                <Modal.Body>
                    <Row>
                        ...
                        <Col sm={6}>
                            <div className="form-group fill">
                                <label className="floating-label" htmlFor="Price">
                                    <small className="text-danger">* </small>Membership Price
                                </label>
                        ...
                        <Col sm={6}>
                            <div className="form-group fill">
                                <label className="floating-label" htmlFor="Period">
                                    <small className="text-danger">* </small>Membership Period
                                </label>
                        ...
                        <Col sm={12}>
                            ...
                            <div className="form-group fill">
                                <label className="floating-label" htmlFor="Description" style={{ top: 0 }}>
                                    Description
                                </label>
