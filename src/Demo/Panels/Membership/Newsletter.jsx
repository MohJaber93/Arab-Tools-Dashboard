...
const Newsletter = () => {
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="0" bgcolor="#F0F0F0" style="width: 38.9137%; margin-left: 29.0096%;">
        <tbody>
            <tr>
                <td style="background-color: #ffffff;" align="center" valign="top" bgcolor="#ffffff"><br>
                    <table style="width: 149.259%; max-width: 600px;" border="0" width="100%" cellspacing="0" cellpadding="0">
                        <tbody>
                            <tr>
                                <td height="30"> </td>
                            </tr>
