                        ...
                        <Card.Body className="text-center">
                            ...
                            <ul className="list-inline">
                                <li className="list-inline-item border-right m-0">
                                    <a href={DEMO.BLANK_LINK} className="pr-2 pl-1 text-muted">
                                        {' '}
                                        Sorting Options{' '}
                                    </a>
                                </li>
                                <li className="list-inline-item border-right m-0">
                                    <a href={DEMO.BLANK_LINK} className="pr-2 pl-1 font-weight-bolder">
                                        {' '}
                                        Reset{' '}
                                    </a>
                                </li>
                            ...
                            <ul className="list-inline mb-0">
                                ...
                                <li className="list-inline-item">
                                    <a href={DEMO.BLANK_LINK} className="font-weight-bolder">
                                        {' '}
                                        All{' '}
                                    </a>
                                </li>
                    ...
                    <Card className="user-card user-card-1 mt-4">
                        <Card.Body className="pt-0">
                                ...
                                <Row className="align-items-end">
                                    ...
                                    <Col className="text-right pb-3">
                                        <Dropdown className="dropdown">
                                            <Dropdown.Toggle as="a" className="drp-icon dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div className="text-center">
                                <a href={DEMO.BLANK_LINK} onClick={() => setIsOpen(true)}>
                                ...
                                <p className="mb-0">
                                    <b>Membership : </b>Platinum <span className="badge badge-warning">member</span>
                                </p>
                            </div>
                        </Card.Body>
                    </Card>
                    ...
                    <Card className="user-card user-card-1 mt-4">
                        <Card.Body className="pt-0">
                            ...
                            <div className="text-center">
                                ...
                                <p className="mb-0">
                                    <b>Membership : </b>TRIAL <span className="badge badge-warning">member</span>
                                </p>
                            </div>
                        </Card.Body>
                    </Card>
                    ...
                    <Card className="user-card user-card-1 mt-4">
                        <Card.Body className="pt-0">
                            ...
                            <div className="text-center">
                                ...
                                <p className="mb-0">
                                    <b>Membership : </b>- <span className="badge badge-primary">staff</span>
                                </p>
                            </div>
                        </Card.Body>
                    </Card>
                    ...
                    <Card className="user-card user-card-1 mt-4">
                        <Card.Body className="pt-0">
                            ...
                            <div className="text-center">
                                ...
                                <p className="mb-0">
                                    <b>Membership : </b>Bronze <span className="badge badge-warning">member</span>
                                </p>
                            </div>
                        </Card.Body>
                    </Card>
                    ...
                    <Card className="user-card user-card-1 mt-4">
                        <Card.Body className="pt-0">
                            ...
                            <div className="text-center">
                                ...
                                <p className="mb-0">
                                    <b>Membership : </b>GOLD <span className="badge badge-warning">member</span>
                                </p>
                            </div>
                        </Card.Body>
                    </Card>
                    ...
                    <Card className="user-card user-card-1 mt-4">
                        <Card.Body className="pt-0">
                            ...
                            <div className="text-center">
                                ...
                                <p className="mb-0">
                                    <b>Membership : </b>- <span className="badge badge-danger">editor</span>
                                </p>
                            </div>
                        </Card.Body>
                    </Card>
