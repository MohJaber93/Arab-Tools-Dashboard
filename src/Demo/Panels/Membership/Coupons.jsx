                ...
                <Col sm={12}>
                    <div className="text-center">
                        <Button variant="primary" className="btn-sm btn-round has-ripple" onClick={() => setIsOpen(true)}>
                            <i className="feather icon-plus"/> Add Coupon
                        </Button>
                    </div>
                    <Modal size="lg" show={isOpen} onHide={() => setIsOpen(false)}>
                        ...
                        <Modal.Body>
                            <Row>
                                <Col sm={6}>
                                    <div className="form-group fill">
                                        <label className="floating-label" htmlFor="Name">
                                            <small className="text-danger">* </small>Coupons Name
                                        </label>
                                ...
                                <Col sm={6}>
                                    <div className="form-group fill">
                                        <label className="floating-label" htmlFor="Coupon-Code">
                                            Coupon Code
                                        </label>
                            ...
                            <Row>
                                <Col sm={6}>
                                    <div className="form-group fill">
                                        <label className="floating-label" htmlFor="Apply">
                                            <small className="text-danger">* </small>Apply to memberships
                                        </label>
                                ...
                                <Col sm={6}>
                                    <div className="form-group fill">
                                        <label className="floating-label" htmlFor="DiscountAmount">
                                            Discount Amount
                                        </label>
