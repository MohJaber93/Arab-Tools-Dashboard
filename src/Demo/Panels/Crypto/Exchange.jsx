                    ...
                    <Card className="bg-pattern">
                        <Card.Body className="py-5">
                            <h1 className="text-center mb-4">
                                <span className="text-success">Buy</span> and <span className="text-danger">Sell</span> Coins at the Crypto
                            </h1>
                            ...
                            <div className="row justify-content-center">
                                ...
                                <div className="col-sm-12 text-center">
                                    <a href={DEMO.BLANK_LINK} className="btn btn-primary mt-4">
                                        EXCHANGE NOW
                                    </a>
                                </div>
                            </div>
