                            ...
                            <Card className="rounded-0">
                                <Card.Body>
                                    <Row className="justify-content-between align-items-center mb-3">
                                        <Col>
                                            <span className="d-flex justify-content-center align-items-center">
                                                <i className="fab fa-asymmetrik text-c-blue f-22 m-r-5"/>
                                                Neo(NEO)
                                            </span>
                                        </Col>
                                        <Col>
                            ...
                            <Card>
                                ...
                                <Card.Body>
                                    <h5 className="text-primary">
                                        Payment* <small className="text-muted ml-5">0.00001BTC</small>
                                    </h5>
                            ...
                            <Card>
                                ...
                                <Card.Body>
                                    ...
                                    <div className="form-group fill mb-5">
                                        <label className="floating-label" htmlFor="text1">
                                            Key
                                        </label>
                                    ...
                                    <div className="form-group fill mb-5">
                                        <label className="floating-label" htmlFor="text2">
                                            Key
                                        </label>
                                        <input type="text" className="form-control" id="text2" aria-describedby="emailHelp" defaultValue="sD12F42xvR2de2xsD12F42xv"/>
                                    </div>
                                    <a href={DEMO.BLANK_LINK} className="btn btn-success btn-sl-sm">
                                        Settings
                                    </a>
                                    <a href={DEMO.BLANK_LINK} className="btn btn-outline-success btn-sl-sm">
                                        View All
                                    </a>
                                </Card.Body>
                            </Card>
