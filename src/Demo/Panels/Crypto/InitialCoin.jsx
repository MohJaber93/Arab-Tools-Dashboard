                    ...
                    <Card className="bg-pattern">
                        <Card.Header className="py-5 text-center">
                            <h2 className="text-center mb-4">
                                <span className="text-primary">Crypto</span> The <span className="text-primary">Revolution</span> In Crypto
                                Market
                            </h2>
                            ...
                            <div className="clock m-5">
                                <Timer initialTime={60000 * 60 * 24 * 10 - 1000} direction="backward">
                                    {() => (<React.Fragment>
                                            <span style={{ lineHeight: 2 }} className="m-2 px-2 bg-dark rounded display-4 text-white">
                                                <Timer.Days />
                                            </span>
                                            <span style={{ lineHeight: 2 }} className="m-2 px-2 bg-dark rounded display-4 text-white">
                                                D
                                            </span>
                                            <span style={{ lineHeight: 2 }} className="text-dark m-2 display-4">
                                                :
                                            </span>
                    ...
                    <Card className="bg-pattern">
                        <Card.Body className="py-5 text-center">
                            ...
                            <div className="row align-items-end">
                                ...
                                <div className="col-sm-2">
                                    <div className="badge badge-pill badge-success m-b-5">bonus</div>
                                    <p>23%</p>
                                </div>
                                <div className="col-sm-2">
                                    <div className="badge badge-pill badge-success m-b-5">bonus</div>
