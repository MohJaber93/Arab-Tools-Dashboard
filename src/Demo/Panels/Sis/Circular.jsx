                    ...
                    <Card>
                        <Card.Header>
                            <div className="nav nav-pills" role="tablist">
                                <a href={DEMO.BLANK_LINK} className="nav-link active">
                                    2018 - 19
                                </a>
                                <a href={DEMO.BLANK_LINK} className="nav-link">
                                    2017 - 18
                                </a>
                                <a href={DEMO.BLANK_LINK} className="nav-link">
                                    2016 - 17
                                ...
                                <Row>
                                    <Col sm={3}>
                                        <Nav variant="pills" className="flex-column">
                                            <Nav.Item>
                                                <Nav.Link eventKey="gn">General Notices</Nav.Link>
                                            </Nav.Item>
                                            <Nav.Item>
                                                <Nav.Link eventKey="en">Exam Notices</Nav.Link>
                                            </Nav.Item>
                                            <Nav.Item>
                                                <Nav.Link eventKey="sn">Seat No</Nav.Link>
                                            </Nav.Item>
                                            <Nav.Item>
                                                <Nav.Link eventKey="sa">Seating Arrangement</Nav.Link>
                                            </Nav.Item>
                                            <Nav.Item>
                                                <Nav.Link eventKey="fr">Results</Nav.Link>
                                            </Nav.Item>
                                        </Nav>
                                    </Col>
                                    <Col sm={9}>
                                                ...
                                                <Table bordered responsive>
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>20/05/2019</td>
                                                            <td>
                                                                <a href="#!">Ph D Fee Notice 2019-20</a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>02/05/2019</td>
                                                            <td>
                                                                <a href="#!">09-2019 - Time Duration for Exit Application</a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>25/04/2019</td>
                                                            <td>
                                                                <a href="#!">FEE NOTICE for 1st Term Academic Year 2019-20</a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>19/02/2019</td>
                                                            <td>
                                                                <a href="#!">
                                                                    35-2019 Revised rules and Regulation for usage of Auditurium etc.
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>14/02/2019</td>
                                                            <td>
                                                                <a href="#!">36-2019 B.U.Patel Scholarship Scheme 2018-19</a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>08/01/2019</td>
                                                            <td>
                                                                <a href="#!">Ph. D. Fee Extension Notice</a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>11/12/2018</td>
                                                            <td>
                                                                <a href="#!">Fees Notice for (4, 6, 8, 10 Sem) 2018-19</a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>25/10/2018</td>
                                                            <td>
                                                                <a href="#!">2nd Term Fees Notice</a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>05/10/2018</td>
                                                            <td>
                                                                <a href="#!"> Electroal Literacy Club</a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>11/09/2018</td>
                                                            <td>
                                                                <a href="#!"> Circular - 03-2018 Migration Certificates</a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>06/09/2018</td>
                                                            <td>
                                                                <a href="#!"> 19/2018, Appointment of I/c. Director Management (SRIMCA)</a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>31/08/2018</td>
                                                            <td>
                                                                <a href="#!">1st Term MBNC Fees Notice</a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td rowSpan={6}>28/08/2018</td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <a href="#!">Community Social service Club</a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td rowSpan={9}>09/08/2018</td>
                                                            <td>
                                                                <a href="#!">International Collaboration Cell</a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <a href="#!">Entrepreneurship Development & Startup Cell</a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <a href="#!">Committee Against Sexual Harassment</a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <a href="#!">Academic Development Cell</a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <a href="#!">Data Collection Committee</a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                ...
                                                <Table bordered responsive>
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="#!">
                                                                    Internal CIE Improvement Application Date Extended 3 Aug 2019
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <Table bordered responsive>
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <a href="#!">B.Sc. (Chemistry)</a>
                                                                            </td>
                                                                            <td>
                                                                                <a href="#!">B.Sc. (Microbiology)</a>
                                                                            </td>
                                                                            <td>
                                                                                <a href="#!">B.Tech (Automobile)</a>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>
                                                                                <a href="#!">B.Tech (Chemical)</a>
                                                                            </td>
                                                                            <td>
                                                                                <a href="#!">B.Tech (Civil)</a>
                                                                            </td>
                                                                            <td>
                                                                                <a href="#!">B.Tech (EC)</a>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <a href="#!">Diploma (Chemical)</a>
                                                                            </td>
                                                                            <td>
                                                                                <a href="#!">Diploma (Civil)</a>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>
                                                                            ...
                                                                            <td>
                                                                                <a href="#!">Integrated M.Sc. (Biotechnology)</a>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>
                                                                                <a href="#!">Integrated M.Sc. (IT)</a>
                                                                            </td>
                                                                            <td>
                                                                                <a href="#!">Integrated M.Sc. (Mathematics)</a>
                                                                            </td>
                                                                            <td>
                                                                                <a href="#!">Integrated M.Sc. (Microbiology)</a>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>
                                                                            ...
                                                                            <td>
                                                                                <a href="#!">M.Com (Integrated)</a>
                                                                            </td>
                                                                            <td>
                                                                                <a href="#!">M.Sc. (Industrial Chemistry)</a>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>
                                                                                <a href="#!">MBA (Integrated)-OLD</a>
                                                                            </td>
                                                                            <td>
                                                                                <a href="#!">MBA</a>
                                                                            </td>
                                                                            <td>
                                                                                <a href="#!">MCA (Integrated)</a>
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                </Table>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="#!">
                                                                    Online Exam Batch Details of Sem 6 UTU Common Subject Soft Skills on
                                                                    1.5.2019.
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <a href="#!">
                                                                    Summer 2019 - Exam Form-Date-Extended-19-25 March 2019 - With Penalty
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="#!">
                                                                    Re Checking Schedule - Round2- Winter2018-Exam - 21 Jan 2019
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="#!">
                                                                    Re Schedule Online Exam BBA - BCom - BCom CA- I.MCom - Sem1 - 1 Nov 2018
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="#!">
                                                                    Winter 2018 Regular ATKT - Odd Sem Exam Form Filling Schedule
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td rowSpan={3}>17/07/2018</td>
                                                            <td>
                                                                <a href="#!">
                                                                    Online Examination Form Filling Schedule - ATKT (AllCourses) and Nursing
                                                                    - Winter2018
                                                                </a>
                                                            </td>
                                                        </tr>
