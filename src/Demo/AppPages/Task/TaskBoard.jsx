...
const TaskBoard = () => {
    ...
    const collapseHandler = (activeKey) => {
        if (activateCollapse.findIndex((item) => item === activeKey) > -1) {
            setActivateCollapse(activateCollapse.filter((item) => item !== activeKey));
        }
        else {
            setActivateCollapse([...activateCollapse, activeKey]);
        }
    };
    return (<>
            <Row>
                        ...
                        <Card.Body>
                            <div className="input-group mb-3">
                                ...
                                <div className="input-group-append">
                                    <button className="btn btn-primary btn-msg-send" type="button">
                                        <i className="fa fa-search"/>
                                    </button>
                                </div>
                            </div>
                            <div className="task-right">
                                <div className="task-right-header-status" onClick={() => collapseHandler(1)} aria-controls="completed-status">
                    ...
                    <nav className="navbar m-b-30 p-10">
                        <ul className="nav">
                            <li className="nav-item f-text active">
                                <a className="nav-link text-secondary" href={DEMO.BLANK_LINK}>
