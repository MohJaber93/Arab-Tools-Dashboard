...
import { Row, Col, Card, Carousel, ProgressBar, Dropdown, ButtonToolbar, DropdownButton } from 'react-bootstrap';
...
const DropDownBtn = () => {
    return (<DropdownButton drop="left" title={'This Year'} variant={'outline-secondary'} id={`dropdown-variants-${'secondary'}`} key={'secondary'} className="no-arrow">
            <Dropdown.Item eventKey="1">1 Week</Dropdown.Item>
            <Dropdown.Item eventKey="2">2 Month</Dropdown.Item>
            <Dropdown.Item eventKey="3">3 Year</Dropdown.Item>
        </DropdownButton>);
};
const WdgtStatistic = () => {
    return (<>
            <Row>
                ...
                <Col xl={4} md={12}>
                    <Card className="bg-c-yellow order-card">
                        <Card.Body>
                            ...
                            <p className="m-b-0">
                                $5,032 <i className="feather icon-arrow-up m-l-10"/>
                            </p>
                ...
                <Col xl={4} md={12}>
                    <Card className="bg-c-blue order-card">
                        <Card.Body>
                            ...
                            <p className="m-b-0">
                                $5,032 <i className="feather icon-arrow-up m-l-10 m-r-10"></i>$1,055{' '}
                ...
                <Col xl={4} md={12}>
                    <Card className="bg-c-green order-card">
                        <Card.Body>
                            ...
                            <p className="m-b-0">
                                $5,032 <i className="feather icon-arrow-down m-l-10 m-r-10"></i>$1,055{' '}
                ...
                <Col xl={4} md={6}>
                    <Card>
                        <Card.Body className="text-center">
                            ...
                            <h4 className="m-t-20">
                                <span className="text-c-blue">8.62k</span> Subscribers
                            </h4>
                ...
                <Col xl={4} md={6}>
                    <Card>
                        <Card.Body className="text-center">
                            ...
                            <h4 className="m-t-20">
                                <span className="text-c-green">+40</span> Followers
                            </h4>
                            <p className="m-b-20">Your main list is growing</p>
                ...
                <Col xl={4} md={6}>
                    <Card className="social-card bg-c-red">
                        ...
                        <a href={DEMO.BLANK_LINK} className="download-icon t-0">
                            <i className="feather icon-arrow-down"/>
                        </a>
                    </Card>
                </Col>
                <Col xl={4} md={6}>
                    <Card className="social-card bg-c-blue">
                        ...
                        <a href={DEMO.BLANK_LINK} className="download-icon">
                            <i className="feather icon-arrow-down"/>
                        </a>
                    </Card>
                </Col>
                    ...
                    <Card className="text-center order-visitor-card">
                        <Card.Body>
                            ...
                            <h4 className="m-t-15 m-b-15">
                                <i className="icon feather icon-arrow-down m-r-15 text-c-red"/>
                                7652
                            </h4>
                ...
                <Col xl={3} md={6}>
                    <Card className="text-center order-visitor-card">
                        <Card.Body>
                            ...
                            <h4 className="m-t-15 m-b-15">
                                <i className="icon feather icon-arrow-up m-r-15 text-c-green"/>
                                6325
                            </h4>
                            ...
                            <div className="team-box p-b-20">
                                ...
                                <div className="team-section d-inline-block">
                                    <a href={DEMO.BLANK_LINK}>
                                        <img src={avatar1} data-toggle="tooltip" title="Josephin Doe" alt=" "/>
                                    </a>
                                    <a href={DEMO.BLANK_LINK}>
                                        <img src={avatar3} data-toggle="tooltip" title="Lary Doe" alt=" " className="m-l-5 "/>
                                    </a>
                                    <a href={DEMO.BLANK_LINK}>
                                        <img src={avatar4} data-toggle="tooltip" title="Alia" alt=" " className="m-l-5 "/>
                                    </a>
                                    <a href={DEMO.BLANK_LINK}>
                                        <img src={avatar2} data-toggle="tooltip" title="Suzen" alt=" " className="m-l-5 "/>
                                    </a>
                                </div>
                            </div>
                    ...
                    <Card className="app-design">
                        <Card.Body>
                            ...
                            <div className="team-box p-b-20">
                                ...
                                <div className="team-section d-inline-block">
                                    <a href={DEMO.BLANK_LINK}>
                                        <img src={avatar3} data-toggle="tooltip" title="Josephin Doe" alt=" "/>
                                    </a>
                                    <a href={DEMO.BLANK_LINK}>
                                        <img src={avatar4} data-toggle="tooltip" title="Lary Doe" alt=" " className="m-l-5 "/>
                                    </a>
                                    <a href={DEMO.BLANK_LINK}>
                                        <img src={avatar2} data-toggle="tooltip" title="Alia" alt=" " className="m-l-5 "/>
                                    </a>
                                    <a href={DEMO.BLANK_LINK}>
                                        <img src={avatar1} data-toggle="tooltip" title="Suzen" alt=" " className="m-l-5 "/>
                                    </a>
                                </div>
                            </div>
                            <div className="progress-box">
                        ...
                        <Row className="m-l-0 m-r-0">
                            <Col sm={4} className="bg-c-blue user-profile-side">
                                <Card.Body className="text-center text-white">
                                    ...
                                    <p>Web Designer</p>
                                    <a href={DEMO.BLANK_LINK} className="text-white">
                                        <i className="feather icon-edit m-t-10 f-16"/>
                                    </a>
                                </Card.Body>
                            </Col>
                            <Col sm={8}>
                                <Card.Body>
                                    ...
                                    <ul className="social-link list-unstyled m-t-50 m-b-20">
                                        <li>
                                            <a href={DEMO.BLANK_LINK} data-toggle="tooltip" data-placement="bottom" title="" data-original-title="facebook">
                                                <span className="hidden"/>
                                                <i className="feather icon-facebook facebook" aria-hidden="true"/>
                                            </a>
                                        </li>
                                        <li>
                                            <a href={DEMO.BLANK_LINK} data-toggle="tooltip" data-placement="bottom" title="" data-original-title="twitter">
                                                <span className="hidden"/>
                                                <i className="feather icon-twitter twitter" aria-hidden="true"/>
                                            </a>
                                        </li>
                                        <li>
                                            <a href={DEMO.BLANK_LINK} data-toggle="tooltip" data-placement="bottom" title="" data-original-title="instagram">
                                                <span className="hidden"/>
                                                <i className="feather icon-instagram instagram" aria-hidden="true"/>
                                            </a>
                                        </li>
                                    </ul>
                                </Card.Body>
                    ...
                    <Card className="quater-card">
                        <Card.Body>
                            ...
                            <p className="text-muted mb-2">
                                Online Revenue<span className="float-right">80%</span>
                            </p>
                            <ProgressBar variant="primery" now={80}/>
                            <h5 className="m-t-20 mb-1">68</h5>
                            <p className="text-muted mb-2">
                                Offline Revenue<span className="float-right">50%</span>
                            </p>
                            <ProgressBar variant="success" now={50}/>
                            <h5 className="m-t-20 mb-1">68</h5>
                            <p className="text-muted mb-2">
                                Dealer Revenue<span className="float-right">30%</span>
                            </p>
                            ...
                            <Row className="align-items-center">
                                <Col>
                                    <label className="badge badge-light-success">
                                        35% <i className="m-l-10 feather icon-arrow-up"></i>
                                    </label>
                                </Col>
                            ...
                            <Row className="align-items-center">
                                <Col>
                                    <label className="badge badge-light-primary">
                                        35% <i className="m-l-10 feather icon-arrow-up"/>
                                    </label>
                                </Col>
                                <Col className="text-right">
                                    <h5 className="">28</h5>
                ...
                <Col xl={3} md={6}>
                    <Card className="statustic-progress-card">
                        <Card.Body>
                            ...
                            <Row className="align-items-center">
                                <Col>
                                    <label className="badge badge-light-warning">
                                        35% <i className="m-l-10 feather icon-arrow-up"/>
                                    </label>
                                </Col>
                                <Col className="text-right">
                            ...
                            <Row className="no-gutters">
                                    ...
                                    <Card className="bg-dark rounded-0 shadow-none">
                                        <Card.Body className="d-flex justify-content-between align-items-center">
                                            <span className="text-white d-flex justify-content-center align-items-center">
                                                <i className="fab fa-ethereum text-c-red f-22 m-r-5"/>
                                                Ethereum(ETH)
                                            </span>
                                ...
                                <Col>
                                    <Card className="bg-dark rounded-0 shadow-none">
                                        <Card.Body className="d-flex justify-content-between align-items-center">
                                            <span className="text-white d-flex justify-content-center align-items-center">
                                                <i className="fab fa-bitcoin text-c-yellow f-22 m-r-5"/>
                                                Bitcoin(BTC)
                                            </span>
                                ...
                                <Col>
                                    <Card className="bg-dark rounded-0 shadow-none">
                                        <Card.Body className="d-flex justify-content-between align-items-center">
                                            <span className="text-white d-flex justify-content-center align-items-center">
                                                <i className="fab fa-cloudsmith text-c-blue f-22 m-r-5"/>
                                                Ripple(RPL)
                                            </span>
                                ...
                                <Col>
                                    <Card className="bg-dark rounded-0 shadow-none">
                                        <Card.Body className="d-flex justify-content-between align-items-center">
                                            <span className="text-white d-flex justify-content-center align-items-center">
                                                <i className="fab fa-asymmetrik text-c-yellow f-22 m-r-5"/>
                                                Neo(NEO)
                                            </span>
                    ...
                    <Row className="no-gutters">
                        ...
                        <Col xl={3} md={6}>
                            <Card className="rounded-0">
                                <Card.Body className="d-flex justify-content-between align-items-center">
                                    <span className="d-flex justify-content-center align-items-center">
                                        <i className="fab fa-cloudsmith text-c-green f-22 m-r-5"/>
                                        Ripple(RPL)
                                    </span>
                    ...
                    <Card>
                        <Card.Body>
                            ...
                            <Row>
                                ...
                                <Col>
                                    <h3 className="m-0">
                                        <i className="fas fa-circle text-primary f-10 m-r-5"/>
                                        26%
                                    </h3>
                            ...
                            <div className="row align-items-center justify-content-center">
                                <div className="col-auto">
                                    <h2 className="text-c-purple m-0">
                                        <i className="feather icon-cloud-snow text-muted mr-2"/>
                                        23<sup className="f-20">°</sup>
                                    </h2>
                                </div>
                        ...
                        <Card.Body>
                            ...
                            <Row className="mt-2">
                                <Col sm={6}>
                                    ...
                                    <span className="d-block">
                                        <i className="fas fa-circle text-c-red f-10 m-r-10"/>
                                        France
                                    </span>
                                    <span className="d-block">
                    ...
                    <Card>
                        ...
                        <Card.Body>
                            <Row>
                                <Col>
                                    <h2 className="m-0">
                                        <i className="feather icon-arrow-up text-c-green"/>4
                                    </h2>
                                </Col>
                                <Col className="text-right">
                ...
                <Col xl={3} md={6}>
                    <Card className="ticket-card">
                        <Card.Body>
                            <p className="m-b-25 badge-light-danger lbl-card">
                                <i className="fas fa-folder-open m-r-5"/> Open Tickets
                            </p>
                            <div className="text-center">
                                ...
                                <p className="m-b-0 m-t-10">
                                    <i className="fas fa-caret-down m-r-10 f-18 text-c-red"/>
                                    From Previous Month
                                </p>
                            </div>
                        </Card.Body>
                ...
                <Col xl={3} md={6}>
                    <Card className="ticket-card">
                        <Card.Body>
                            <p className="m-b-25 badge-light-primary lbl-card">
                                <i className="fas fa-file-archive m-r-5"/> Close Tickets
                            </p>
                            <div className="text-center">
                                <h2 className="m-b-0 d-inline-block text-c-blue">134</h2>
                                <p className="m-b-0 d-inline-block">Tickets</p>
                                <p className="m-b-0 m-t-10">
                                    <i className="fas fa-caret-up m-r-10 f-18 text-c-blue"/>
                                    From Previous Month
                                </p>
                            </div>
                        </Card.Body>
                ...
                <Col xl={3} md={6}>
                    <Card className="ticket-card">
                        <Card.Body>
                            <p className="m-b-25 badge-light-success lbl-card">
                                <i className="fas fa-users m-r-5"/> New Clients
                            </p>
                            <div className="text-center">
                                <h2 className="m-b-0 d-inline-block text-c-green">307</h2>
                                <p className="m-b-0 d-inline-block">Clients</p>
                                <p className="m-b-0 m-t-10">
                                    <i className="fas fa-caret-up m-r-10 f-18 text-c-green"/>
                                    From Previous Month
                                </p>
                            </div>
                        </Card.Body>
                ...
                <Col xl={3} md={6}>
                    <Card className="ticket-card">
                        <Card.Body>
                            <p className="m-b-25 badge-light-warning lbl-card">
                                <i className="fas fa-database m-r-5"/> New Orders
                            </p>
                            <div className="text-center">
                                <h2 className="m-b-0 d-inline-block text-c-yellow">231</h2>
                                <p className="m-b-0 d-inline-block">Orders</p>
                                <p className="m-b-0 m-t-10">
                                    <i className="fas fa-caret-up m-r-10 f-18 text-c-yellow"/>
                                    From Previous Month
                                </p>
                            </div>
                        </Card.Body>
