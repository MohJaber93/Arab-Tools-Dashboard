                            ...
                            <Row>
                                <Col md={6} xl={3} className="m-t-10 m-b-10">
                                    ...
                                    <h5 className="m-t-10 m-b-0">
                                        <i className="fa fa-caret-up text-c-green m-r-10"/>
                                        $16524
                                    </h5>
                                </Col>
                                <Col md={6} xl={3} className="m-t-10 m-b-10">
                        ...
                        <Card.Body className="bg-c-red text-white">
                            <h6 className="text-white">
                                ...
                                <span className="float-right">
                                    <i className="feather icon-trending-down m-r-15"/>
                                    3%
                                </span>
                            </h6>
                            <Chart {...saleChart1}/>
                    ...
                    <Card className="overflow-hidden">
                        <Card.Body className="bg-c-blue text-white">
                            <h6 className="text-white">
                                Sales Per Day{' '}
                                <span className="float-right">
                                    <i className="feather icon-trending-up m-r-15"/>
                                    12%
                                </span>
                            </h6>
                            <Chart {...saleChart1}/>
                ...
                <Col md={6} xl={4}>
                    <Card>
                        <Card.Body>
                            ...
                            <h2>
                                7.3<span className="text-muted m-l-10 f-14">m3</span>
                            </h2>
                            <Chart {...powerCard2}/>
                            <Row>
                                <Col sm="auto">
                    ...
                    <Card>
                        <Card.Body>
                            ...
                            <p className="text-c-green f-w-500">
                                <i className="fa fa-caret-up m-r-15"></i> 18% High than last month
                            </p>
                            <Row>
                                <Col className="b-r-default">
                                    <p className="text-muted m-b-5">Overall</p>
                    ...
                    <Card>
                        <Card.Body>
                            ...
                            <p className="text-c-red f-w-500">
                                <i className="fa fa-caret-down m-r-15"></i> 24% High than last month
                            </p>
                            <Row>
                                <Col className="b-r-default">
                                    <p className="text-muted m-b-5">Overall</p>
                ...
                <Col md={6} xl={4}>
                    <Card>
                        <Card.Body>
                            ...
                            <p className="text-c-green f-w-500">
                                <i className="fa fa-caret-up m-r-15"></i> 20% High than last month
                            </p>
                            <Row>
                                <Col className="b-r-default">
                                    <p className="text-muted m-b-5">Overall</p>
                            ...
                            <Row className="align-items-center">
                                <Col sm={6}>
                                    ...
                                    <h6 className="mb-0 mt-3">
                                        Close: <span className="text-success">120</span>
                                    </h6>
                                    <h6>
                                        Response <span className="text-danger">2d</span>
                                    </h6>
                                </Col>
                                <Col sm={6}>
                        ...
                        <Card.Body>
                            ...
                            <Row>
                                <Col sm={6} className="pr-0">
                                    <h6 className="my-3">
                                        <i className="feather icon-monitor f-20 mr-2 text-primary"/>
                                        66.6%
                                    ...
                                    <h6 className="my-3">
                                        <i className="feather icon-tablet f-20 mr-2 text-success"/>
                                        29.7%
                                    ...
                                    <h6 className="my-3">
                                        <i className="feather icon-smartphone f-20 mr-2 text-danger"/>
                                        32.8%
                                        <span className="text-c-green ml-2 f-14">
                                            <i className="feather icon-arrow-up"/>
                                            8%
            ...
            <Row>
                <Col xl={4} md={5}>
                    <Card className="rating-bar">
                        <Card.Body>
                            ...
                            <Rating stop={16} initialRating={blockRating} emptySymbol={<span className="theme-bar-block">
                                        <span />
                                    </span>} fullSymbol={<span className="theme-bar-block">
                                        <span className="active"/>
                                    </span>} onChange={(rate) => setBlockRating(rate)}/>
                        </Card.Body>
                    </Card>
                    <Card>
                        <Card.Header>
                        ...
                        <Col xl={6} md={12}>
                            <Card>
                                <Card.Body className="pb-0">
                                    ...
                                    <h4 className="m-0">
                                        0.85%
                                        <span className="text-c-blue ml-2">
                                            <i className="feather icon-arrow-up"/>
                                            0.50%
                                        </span>
                                    </h4>
                ...
                <Col xl={6}>
                    <Card>
                        <Card.Body>
                            ...
                            <span>
                                It takes continuous effort to maintain high customer satisfaction levels.Internal and external quality
                                measures are often tied together.,as the opinion...
                            </span>
                ...
                <Col xl={4} md={12}>
                    <Card>
                        <Card.Body className="pb-0">
                            <h6>
                                New stock <span className="text-muted">( purchased )</span>
                            </h6>
                            <h4 className="m-0">
                                0.85%
                        ...
                        <Card.Body>
                            ...
                            <div className="mt-3">
                                <span className="d-block mb-2">
                                    <i className="fas fa-circle f-10 m-r-15 text-danger"/>
                                    Desktop Computers<span className="float-right f-w-400">76.7%</span>
                                </span>
                                <span className="d-block mb-2">
                                    <i className="fas fa-circle f-10 m-r-15 text-warning"/>
                                    Smartphones<span className="float-right f-w-400">15%</span>
                                </span>
                                <span className="d-block">
                                    <i className="fas fa-circle f-10 m-r-15 text-info"/>
                                    Tablets<span className="float-right f-w-400">30%</span>
                                </span>
                            </div>
                        </Card.Body>
                    </Card>
                    ...
                    <Row>
                            ...
                            <Card className="mrr-card">
                                <Card.Body className="mb-3">
                                    <span className="d-flex align-items-center">
                                        <i className="fab fa-bitcoin text-c-blue f-22 m-r-5"/>
                                        Bitcoin
                                    </span>
                                </Card.Body>
                        ...
                        <Col>
                            <Card className="mrr-card">
                                <Card.Body className="mb-3">
                                    <span className="d-flex align-items-center">
                                        <i className="fab fa-ethereum text-c-green f-22 m-r-5"/>
                                        Ethereum
                                    </span>
                                </Card.Body>
                                <div className="position-absolute bottom-chart w-100">
