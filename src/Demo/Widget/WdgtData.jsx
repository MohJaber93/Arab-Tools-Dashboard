                    ...
                    <Card>
                        ...
                        <Card.Body className="widget-last-task">
                            ...
                            <div className="form-group">
                                <input type="text" name="task-insert" className="form-control add_task_todo" id="Task" placeholder="Add Task"/>
                        ...
                        <Card.Body className="widget-last-task">
                            ...
                            <ul className="list-unstyled m-b-25">
                                <li className="d-inline-block">
                                    <img src={avatar2} alt="user" className="img-radius wid-30 m-r-15" data-toggle="tooltip" data-placement="top" title="Tooltip on top"/>
                                </li>
                                <li className="d-inline-block">
                                    <img src={avatar3} alt="user" className="img-radius wid-30 m-r-15" data-toggle="tooltip" data-placement="top" title="Tooltip on top"/>
                                </li>
                                <li className="d-inline-block">
                                    <img src={avatar2} alt="user" className="img-radius wid-30 m-r-15" data-toggle="tooltip" data-placement="top" title="Tooltip on top"/>
                                </li>
                            ...
                            <ul className="list-unstyled">
                                <li className="d-inline-block">
                                    <img src={avatar4} alt="user" className="img-radius wid-30 m-r-15" data-toggle="tooltip" data-placement="top" title="Tooltip on top"/>
                                </li>
                                <li className="d-inline-block">
                                    <img src={avatar2} alt="user" className="img-radius wid-30 m-r-15" data-toggle="tooltip" data-placement="top" title="Tooltip on top"/>
                                </li>
                            ...
                            <div className="form-group m-t-15">
                                <input type="text" name="task-insert" className="form-control" id="Project" placeholder="Add Project"/>
                                <div className="form-icon">
                        ...
                        <Card.Body>
                            <p className="m-b-10">
                                ...
                                <span className="float-right">
                                    <i className="fa fa-caret-up m-r-10"/>
                                    25%
                                </span>
                            </p>
                            <div className="blue">
                            ...
                            <p className="m-b-10 m-t-30">
                                Social{' '}
                                <span className="float-right">
                                    <i className="fa fa-caret-down m-r-10"/>
                                    58
                                </span>
                            </p>
                            <div className="green">
                    ...
                    <Card className="table-card">
                        ...
                        <Card.Body>
                            ...
                            <div className="text-right m-r-20">
                                <a href={DEMO.BLANK_LINK} className=" b-b-primary text-primary">
                                    View all Projects
                                </a>
                            </div>
                        </Card.Body>
                            ...
                            <div className="row m-b-25">
                                ...
                                <div className="col">
                                    ...
                                    <p className="text-muted m-b-0">
                                        <i className="fa fa-clock-o m-r-10"/>2 min ago
                                    </p>
                                </div>
                            </div>
                            <div className="row m-b-25">
                        ...
                        <Card.Body>
                            <div className="row m-b-30">
                                ...
                                <div className="col">
                                    <a href={DEMO.BLANK_LINK}>
                                        <h6 className="m-b-5">
                                            John Deo <span className="text-muted float-right f-13">5:05 PM</span>
                                        </h6>
                                    </a>
                ...
                <Col xl={4} md={12}>
                    <Card className="chat-card">
                        ...
                        <Card.Body>
                            ...
                            <div className="form-group m-t-15">
                                <input type="text" name="task-insert-chat" className="form-control" id="task-inset-msg" placeholder="Send message"/>
                                <div className="form-icon">
                                    <button className="btn btn-primary btn-icon">
                                    ...
                                    <Col>
                                        ...
                                        <p className="text-muted m-b-0">
                                            ...
                                            <span className="text-c-blue">
                                                {' '}
                                                <a href={DEMO.BLANK_LINK} className="text-c-blue">
                                                    latest backup
                                                </a>{' '}
                                            </span>
                                            .
                        ...
                        <Card.Body>
                            <Table responsive hover>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <label className="badge badge-light-success">open</label>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <label className="badge badge-light-primary">progress</label>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <label className="badge badge-light-danger">closed</label>
                                        </td>
                        ...
                        <Card.Body>
                            <Row className="m-b-30">
                                ...
                                <Col>
                                    ...
                                    <p className="text-muted m-b-10">
                                        <i className="fa fa-play-circle-o"/> Video | 14 minutes ago
                                    </p>
                            ...
                            <Row className="m-b-30">
                                ...
                                <Col>
                                    ...
                                    <p className="text-muted m-b-10">
                                        <i className="fa fa-play-circle-o"/> tutorials | 14 minutes ago
                                    </p>
                                    <p className="text-muted m-b-0">Lorem Ipsum is simply dummy text of the.</p>
                                </Col>
                            </Row>
                        ...
                        <Card.Body>
                            <Table responsive hover borderless>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <img src={germany} alt="" className="img-fluid wid-30"/>
                                        </td>
                                        <td>Germany</td>
                                    ...
                                    <tr>
                                        <td>
                                            <img src={usa} alt="" className="img-fluid wid-30"/>
                                        </td>
                                        <td>USA</td>
                                        <td>John Deo</td>
                                    ...
                                    <tr>
                                        <td>
                                            <img src={australia} alt="" className="img-fluid wid-30"/>
                                        </td>
                                        <td>Australia</td>
                                    ...
                                    <tr>
                                        <td>
                                            <img src={uk} alt="" className="img-fluid wid-30"/>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <img src={brazil} alt="" className="img-fluid wid-30"/>
                                        </td>
                                        <td>Brazil</td>
                            ...
                            <div className="latest-update-box">
                                ...
                                <div className="row p-b-30">
                                    ...
                                    <div className="col">
                                        ...
                                        <p className="text-muted m-b-0">
                                            Free courses for all our customers at A1 Conference Room - 9:00 am tomorrow!
                                        </p>
                                    </div>
                                </div>
                                <div className="row p-b-30">
                                    ...
                                    <div className="col">
                                        ...
                                        <iframe title="Able Pro Map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3718.961710410607!2d72.86204201533417!3d21.233366886136675!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be04f1c84348989%3A0xfb5817a0f069bfe5!2sPhoenixcoded!5e0!3m2!1sen!2sin!4v1562323931692!5m2!1sen!2sin" style={{ width: '100%', height: '245px', border: 0 }} frameBorder="0" allowFullScreen/>
                                    </div>
                                </div>
                            </div>
                        ...
                        <Card.Body>
                            <div className="row m-b-30">
                                ...
                                <div className="col">
                                    <a href={DEMO.BLANK_LINK}>
                                        <h6 className="m-b-5">
                                            You have 3 pending tasks. <span className="text-muted float-right f-13">Just Now</span>
                                        </h6>
                                    </a>
                                </div>
                            </div>
                            <div className="row m-b-30">
                                ...
                                <div className="col">
                                    <a href={DEMO.BLANK_LINK}>
                                        <h6 className="m-b-5">
                                            New order received <span className="text-muted float-right f-13">Just Now</span>
                                        </h6>
                                    </a>
                                </div>
                            </div>
                            ...
                            <Table responsive hover borderless>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>17-2-2017</td>
                                        <td>
                                            <label className="badge badge-light-warning">Pending</label>
                                        </td>
                                        <td>
                                            <a href={DEMO.BLANK_LINK}>
                                                <i className="icon feather icon-edit f-w-600 f-16 m-r-15 text-c-green"/>
                                            </a>
                                            <a href={DEMO.BLANK_LINK}>
                                                <i className="feather icon-trash-2 f-w-600 f-16 text-c-red"/>
                                            </a>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>20-2-2017</td>
                                        <td>
                                            <label className="badge badge-light-primary">Paid</label>
                                        </td>
                                        <td>
                                            <a href={DEMO.BLANK_LINK}>
                                                <i className="icon feather icon-edit f-w-600 f-16 m-r-15 text-c-green"/>
                                    ...
                                    <tr>
                                        ...
                                        <td>17-2-2017</td>
                                        <td>
                                            <label className="badge badge-light-success">Success</label>
                                        </td>
                                        <td>
                                            <a href={DEMO.BLANK_LINK}>
                                                <i className="icon feather icon-edit f-w-600 f-16 m-r-15 text-c-green"/>
                                    ...
                                    <tr>
                                        ...
                                        <td>#62446232</td>
                                        <td>
                                            <img src={phone4} alt="" className="img-fluid"/>
                                        </td>
                                        <td>Jio</td>
                                        <td>15</td>
                                        <td>25-4-2017</td>
                                        <td>
                                            <label className="badge badge-light-danger">Failed</label>
                                        </td>
                                        <td>
                                            <a href={DEMO.BLANK_LINK}>
                                                <i className="icon feather icon-edit f-w-600 f-16 m-r-15 text-c-green"/>
                        ...
                        <Card.Body>
                            <div className="review-block">
                                <div className="row">
                                    ...
                                    <div className="col">
                                        <h6 className="m-b-15">
                                            John Deo <span className="float-right f-13 text-muted"> a week ago</span>
                                        </h6>
                                        <a href={DEMO.BLANK_LINK}>
                                        ...
                                        <a href={DEMO.BLANK_LINK} className="m-r-30 text-muted">
                                            <i className="feather icon-thumbs-up m-r-15"/>
                                            Helpful?
                                        </a>
                                        <a href={DEMO.BLANK_LINK}>
                                        ...
                                        <a href={DEMO.BLANK_LINK}>
                                            <i className="feather icon-edit text-muted"/>
                                        </a>
                                    </div>
                                </div>
                                <div className="row">
                                    ...
                                    <div className="col">
                                        <h6 className="m-b-15">
                                            Allina D’croze <span className="float-right f-13 text-muted"> a week ago</span>
                                        </h6>
                                        <a href={DEMO.BLANK_LINK}>
                                            <i className="feather icon-star-on f-18 text-c-yellow"/>
                                        </a>
                ...
                <Col xl={4} md={6}>
                    <Card>
                        <Card.Body>
                            ...
                            <span className="mt-1 d-block mb-3">
                                This Week<span className="float-right">Previous Week</span>
                            </span>
                    ...
                    <Card>
                            ...
                            <div style={{ height: '265px' }}>
                                <PerfectScrollbar>
                                    <div className="mt-3 mb-3">
                                        <span className="px-4 d-block">
                                            <i className="fas fa-circle text-c-blue f-10 m-r-5"/>
                                            Incoming requests
                                        </span>
                                        <hr />
                                        <span className="px-4 d-block">
                                        ...
                                        <hr />
                                        <span className="px-4 d-block">
                                            <i className="fas fa-circle text-c-yellow f-10 m-r-5"/>
                                            New order received
                                        </span>
                                        <hr />
                                        <span className="px-4 d-block">
                                            <i className="fas fa-circle text-c-purple f-10 m-r-5"/>
                                            Incoming requests
                                        </span>
                                        <hr />
                                        <span className="px-4 d-block">
                        ...
                        <Card.Footer>
                            <h6 className="text-center m-0">
                                <a href={DEMO.BLANK_LINK}>Show more</a>
                            </h6>
                        </Card.Footer>
                    </Card>
                </Col>
                                    ...
                                    <Table responsive hover>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>HeadPhone</td>
                                                <td>
                                                    <img src={p1} alt="" className="img-20"/>
                                                </td>
                                                <td>
                                                    <div>
                                                        <label className="badge badge-light-warning">Pending</label>
                                            ...
                                            <tr>
                                                <td>Iphone 6</td>
                                                <td>
                                                    <img src={p2} alt="" className="img-20"/>
                                                </td>
                                                <td>
                                                    <div>
                                                        <label className="badge badge-light-danger">Cancel</label>
                                                    </div>
                                                </td>
                                                <td>$20</td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>Jacket</td>
                                                <td>
                                                    <img src={p3} alt="" className="img-20"/>
                                                </td>
                                                <td>
                                                    <div>
                                                        <label className="badge badge-light-success">Success</label>
                                            ...
                                            <tr>
                                                <td>Sofa</td>
                                                <td>
                                                    <img src={p4} alt="" className="img-20"/>
                                                </td>
                                                <td>
                                                    <div>
                                                        <label className="badge badge-light-danger">Cancel</label>
                                    ...
                                    <Table responsive hover>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>04/08/2018</td>
                                                <td>
                                                    <label className="badge badge-light-success">Paid</label>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>04/08/2019</td>
                                                <td>
                                                    <label className="badge badge-light-danger">Unpaid</label>
                                                </td>
                                            </tr>
                                            <tr>
                                    ...
                                    <Table responsive hover>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>abc@gmail.com</td>
                                                <td>
                                                    <label className="badge badge-light-danger">Out Stock</label>
                                                </td>
                                                <td>
                                                    <a href={DEMO.BLANK_LINK}>
                                                        <i className="fa fa-star f-14 text-c-yellow"/>
                                                    </a>
                                                    <a href={DEMO.BLANK_LINK}>
                                                        <i className="fa fa-star f-14 text-c-yellow"/>
                                                    </a>
                                                    ...
                                                    <a href={DEMO.BLANK_LINK}>
                                                        <i className="fa fa-star f-14 text-muted"/>
                                                    </a>
                                                    <a href={DEMO.BLANK_LINK}>
                                                        <i className="fa fa-star f-14 text-muted"/>
                                                    </a>
                                            ...
                                            <tr>
                                                ...
                                                <td>cdc@gmail.com</td>
                                                <td>
                                                    <label className="badge badge-light-success">In Stock</label>
                                                </td>
                                                <td>
                                                    <a href={DEMO.BLANK_LINK}>
                                                        <i className="fa fa-star f-14 text-c-yellow"/>
                                    ...
                                    <Table responsive hover>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>Task</td>
                                                <td>
                                                    <label className="badge badge-light-danger">Open</label>
                                                </td>
                                                <td>John Malit</td>
                                                <td>Normal</td>
                                                <td>8/8/2017</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>Task</td>
                                                <td>
                                                    <label className="badge badge-light-primary">New</label>
                                                </td>
                                                <td>Ken Malit</td>
                                                <td>low</td>
                                                <td>6/7/2017</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>Task</td>
                                                <td>
                                                    <label className="badge badge-light-success">Close</label>
                                                </td>
                                                <td>Ken Malit</td>
                                                <td>Normal</td>
                                                <td>9/4/2017</td>
                                ...
                                <Card.Body>
                                    <div className="row m-b-25 m-t-5 align-items-center">
                                        ...
                                        <div className="col">
                                            <a href={DEMO.BLANK_LINK}>
                                                <h6 className="m-b-5">
                                                    You have 3 pending tasks. <span className="text-muted float-right f-14">Just Now</span>
                                                </h6>
                                            </a>
                                        </div>
                                    </div>
                                    <div className="row m-b-25 align-items-center">
                                        ...
                                        <div className="col">
                                            <a href={DEMO.BLANK_LINK}>
                                                <h6 className="m-b-5">
                                                    New order received <span className="text-muted float-right f-14">30 min ago</span>
                                                </h6>
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div className="row m-b-25 align-items-center">
                                        ...
                                        <div className="col">
                                            <a href={DEMO.BLANK_LINK}>
                                                <h6 className="m-b-5">
                                                    You have 4 tasks Done. <span className="text-muted float-right f-14">1 hours ago</span>
                                                </h6>
                                            </a>
                                        </div>
                                    </div>
                                    <div className="row m-b-25 align-items-center">
                                        ...
                                        <div className="col">
                                            <a href={DEMO.BLANK_LINK}>
                                                <h6 className="m-b-5">
                                                    You have 2 pending tasks. <span className="text-muted float-right f-14">Just Now</span>
                                                </h6>
                                            </a>
                                        </div>
                                    </div>
                                    <div className="row m-b-25 align-items-center">
                                        ...
                                        <div className="col">
                                            <a href={DEMO.BLANK_LINK}>
                                                <h6 className="m-b-5">
                                                    New order received <span className="text-muted float-right f-14">4 hours ago</span>
                                                </h6>
                                            </a>
                                        </div>
                                    </div>
                                    <div className="row m-b-25 align-items-center">
                                        ...
                                        <div className="col">
                                            <a href={DEMO.BLANK_LINK}>
                                                <h6 className="m-b-5">
                                                    New order Done <span className="text-muted float-right f-14">Just Now</span>
                                                </h6>
                                            </a>
                                        </div>
                                    </div>
                                        ...
                                        <div className="col">
                                            <a href={DEMO.BLANK_LINK}>
                                                <h6 className="m-b-5">
                                                    ...
                                                    <span className="text-muted float-right f-14">5 hours ago</span>
                                                </h6>
                                            </a>
                                        </div>
                                    </div>
                                    <div className="row m-b-0 align-items-center">
                                        ...
                                        <div className="col">
                                            <a href={DEMO.BLANK_LINK}>
                                                <h6 className="m-b-5">
                                                    You have 4 tasks Done. <span className="text-muted float-right f-14">2 hours ago</span>
                                                </h6>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <PerfectScrollbar>
                                    <Table responsive hover>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <img className="rounded-circle m-r-10" style={{ width: '40px' }} src={avatar1} alt="activity-user"/>
                                                </td>
                                                <td>Ida Jorgensen</td>
                                                <td>The quick brown</td>
                                                <td>4:28 PM</td>
                                            ...
                                            <tr>
                                                ...
                                                <td className="text-right">
                                                    <i className="fas fa-circle text-c-yellow f-10"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                    ...
                                    <Table responsive hover>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>$ 16,244</td>
                                                <td>
                                                    <a className=" badge badge-light-primary f-12" href={DEMO.BLANK_LINK}>
                                                        Active
                                                    </a>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>$ 3,937</td>
                                                <td>
                                                    <a className="badge badge-light-warning f-12" href={DEMO.BLANK_LINK}>
                                                        Not Active
                                                    </a>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>$ 28,039</td>
                                                <td>
                                                    <a className="badge badge-light-success f-12" href={DEMO.BLANK_LINK}>
                                                        Paused
                                                    </a>
                                                </td>
                                            </tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <p className="m-0">
                                                        Assigned to <span className="text-c-red">Marcus Poulsen</span>
                                                    </p>
                                                </td>
                                                <td>110,134</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <p className="m-0">
                                                        Assigned to <span className="text-c-blue">Felix Johansen</span>
                                                    </p>
                                                </td>
                                                <td>226,134</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h6 className="mb-1">Social Media App</h6>
                                                    <p className="m-0">
                                                        Assigned to <span className="text-c-green">Ida Jorgensen</span>
                                                    </p>
                                                </td>
                                                <td>500,134</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h6 className="mb-1">Social Media App</h6>
                                                    <p className="m-0">
                                                        Assigned to <span className="text-c-red">Tristan Madsen</span>
                                                    </p>
                                                </td>
                                                <td>326,134</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <img className="rounded-circle" style={{ width: '40px' }} src={avatar4} alt="activity-user"/>
                                                </td>
                                                <td>
                                                    <h6 className="mb-1">Newspaper Wordpress Web</h6>
                                                    <p className="m-0">
                                                        Assigned to <span className="text-c-blue">Marcus Poulsen</span>
                                                    </p>
                                                </td>
                                                <td>110,134</td>
                                    ...
                                    <div className="widget-timeline m-b-25">
                                        <div className="media">
                                            <div className="mr-3 photo-table">
                                                ...
                                                <a href={DEMO.BLANK_LINK}>
                                                    <img className="rounded-circle" style={{ width: '40px' }} src={avatar4} alt="chat-user"/>
                                                </a>
                                            </div>
                                            <div className="media-body">
                                                <h6 className="d-inline-block m-0">The Quick Brown Fox Jumps</h6>
                                    ...
                                    <div className="widget-timeline m-b-25">
                                        <div className="media">
                                            <div className="mr-3 photo-table">
                                                <i className="fas fa-circle text-c-yellow f-10 m-r-10"/>
                                                <a href={DEMO.BLANK_LINK}>
                                                    <img className="rounded-circle" style={{ width: '40px' }} src={avatar5} alt="chat-user"/>
                                                </a>
                                            </div>
                                            <div className="media-body">
                                                <h6 className="d-inline-block m-0">Over The Lazy Dog</h6>
                                    ...
                                    <Table responsive hover>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>$ 874.23</td>
                                                <td>
                                                    <a href={DEMO.BLANK_LINK} className="badge badge-light-primary">
                                                        Active
                                                    </a>
                                                </td>
                                                <td className="text-right">
                                                    ...
                                                    <a href={DEMO.BLANK_LINK}>
                                                        <i className="fa fa-star f-14 text-black-50"/>
                                                    </a>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>$ 235.34</td>
                                                <td>
                                                    <a href={DEMO.BLANK_LINK} className="badge badge-light-warning">
                                                        Not Active
                                                    </a>
                                                </td>
                                                <td className="text-right">
                                            ...
                                            <tr>
                                                ...
                                                <td>$ 233.46</td>
                                                <td>
                                                    <a href={DEMO.BLANK_LINK} className="badge badge-light-success">
                                                        Active
                                                    </a>
                                                </td>
                                                <td className="text-right">
                                    ...
                                    <Table responsive hover>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href={DEMO.BLANK_LINK} className="badge badge-light-primary badge-pill f-12 mr-2">
                                                        Reject
                                                    </a>
                                                    <a href={DEMO.BLANK_LINK} className="badge badge-light-success badge-pill f-12 mr-2">
                                                        Approve
                                                    </a>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href={DEMO.BLANK_LINK} className="badge badge-light-danger badge-pill f-12 mr-2">
                                                        Reject
                                                    </a>
                                                    <a href={DEMO.BLANK_LINK} className="badge badge-light-warning badge-pill f-12 mr-2">
                                                        Approve
                                                    </a>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <h6 className="text-muted">
                                                        <i className="fas fa-circle text-c-green f-10 m-r-15"/>9 Feb 17:38
                                                    </h6>
                                                </td>
                                                <td>
                                                    <a href={DEMO.BLANK_LINK} className="badge badge-light-primary badge-pill f-12 mr-2">
